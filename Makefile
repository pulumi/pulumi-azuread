...
.make/generate_java: .make/schema
	pulumi-java-gen generate --schema provider/cmd/$(PROVIDER)/schema.json --out sdk/java --build gradle-nexus
...
# `cmd/pulumi-resource-azuread/schema.json` is valid and up to date.
