...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-azuread/releases) for this repository*
...
## 5.11.0 (2021-12-03)
* Upgrade to v2.12.0 of the AzureAD Terraform Provider
