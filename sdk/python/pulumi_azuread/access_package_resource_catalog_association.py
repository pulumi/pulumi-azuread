...
class AccessPackageResourceCatalogAssociationArgs:
    def __init__(__self__, *,
                 ...
                 resource_origin_id: pulumi.Input[builtins.str],
                 resource_origin_system: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AccessPackageResourceCatalogAssociation resource.
        :param pulumi.Input[builtins.str] catalog_id: The unique ID of the access package catalog. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_origin_id: The unique identifier of the resource in the origin system. In the case of an Azure AD group, this is the identifier of the group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_origin_system: The type of the resource in the origin system, such as `SharePointOnline`, `AadApplication` or `AadGroup`. Changing this forces a new resource to be created.
        """
    ...
    def resource_origin_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_origin_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "resource_origin_id", value)

    @property
    @pulumi.getter(name="resourceOriginSystem")
    def resource_origin_system(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_origin_system(self, value: pulumi.Input[builtins.str]):
...
class _AccessPackageResourceCatalogAssociationState:
    def __init__(__self__, *,
                 ...
                 resource_origin_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_origin_system: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="resourceOriginId")
    def resource_origin_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier of the resource in the origin system. In the case of an Azure AD group, this is the identifier of the group. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_origin_id")
    ...
    @resource_origin_id.setter
    def resource_origin_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_origin_id", value)

    @property
    @pulumi.getter(name="resourceOriginSystem")
    def resource_origin_system(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the resource in the origin system, such as `SharePointOnline`, `AadApplication` or `AadGroup`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_origin_system")
    ...
    @resource_origin_system.setter
    def resource_origin_system(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_origin_system", value)
...
class AccessPackageResourceCatalogAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            catalog_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_origin_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_origin_system: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessPackageResourceCatalogAssociation':
        """
    ...
    @property
    @pulumi.getter(name="resourceOriginId")
    def resource_origin_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the resource in the origin system. In the case of an Azure AD group, this is the identifier of the group. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_origin_id")
    ...
    @property
    @pulumi.getter(name="resourceOriginSystem")
    def resource_origin_system(self) -> pulumi.Output[builtins.str]:
        """
        The type of the resource in the origin system, such as `SharePointOnline`, `AadApplication` or `AadGroup`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_origin_system")
