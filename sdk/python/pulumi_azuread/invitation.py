...
class InvitationArgs:
    def __init__(__self__, *,
                 ...
                 user_email_address: pulumi.Input[builtins.str],
                 message: Optional[pulumi.Input['InvitationMessageArgs']] = None,
                 user_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Invitation resource.
        :param pulumi.Input[builtins.str] redirect_url: The URL that the user should be redirected to once the invitation is redeemed.
        :param pulumi.Input[builtins.str] user_email_address: The email address of the user being invited.
        ...
        :param pulumi.Input[builtins.str] user_display_name: The display name of the user being invited.
        :param pulumi.Input[builtins.str] user_type: The user type of the user being invited. Must be one of `Guest` or `Member`. Only Global Administrators can invite users as members. Defaults to `Guest`.
        """
    ...
    def user_email_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def user_email_address(self, value: pulumi.Input[builtins.str]):
    ...
    def user_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InvitationState:
    def __init__(__self__, *,
                 message: Optional[pulumi.Input['InvitationMessageArgs']] = None,
                 redeem_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['InvitationMessageArgs'] message: A `message` block as documented below, which configures the message being sent to the invited user. If this block is omitted, no message will be sent.
        :param pulumi.Input[builtins.str] redeem_url: The URL the user can use to redeem their invitation.
        :param pulumi.Input[builtins.str] redirect_url: The URL that the user should be redirected to once the invitation is redeemed.
        :param pulumi.Input[builtins.str] user_display_name: The display name of the user being invited.
        :param pulumi.Input[builtins.str] user_email_address: The email address of the user being invited.
        :param pulumi.Input[builtins.str] user_id: Object ID of the invited user.
        :param pulumi.Input[builtins.str] user_type: The user type of the user being invited. Must be one of `Guest` or `Member`. Only Global Administrators can invite users as members. Defaults to `Guest`.
        """
        if message is not None:
            pulumi.set(__self__, "message", message)
    ...
    def redeem_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @redeem_url.setter
    def redeem_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Invitation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_email_address: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Invitation':
        """
    ...
    @property
    @pulumi.getter(name="redeemUrl")
    def redeem_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL the user can use to redeem their invitation.
        """
        return pulumi.get(self, "redeem_url")
    ...
    @property
    @pulumi.getter(name="userDisplayName")
    def user_display_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The display name of the user being invited.
        """
        return pulumi.get(self, "user_display_name")
    ...
    @property
    @pulumi.getter(name="userEmailAddress")
    def user_email_address(self) -> pulumi.Output[builtins.str]:
        """
        The email address of the user being invited.
        """
        return pulumi.get(self, "user_email_address")
