...
__all__ = [
    ...
    'ConditionalAccessPolicyConditionsApplicationsFilter',
...
class AccessPackageAssignmentPolicyApprovalSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 approval_required_for_extension: Optional[_builtins.bool] = None,
                 approval_stages: Optional[Sequence['outputs.AccessPackageAssignmentPolicyApprovalSettingsApprovalStage']] = None,
                 requestor_justification_required: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool approval_required: Whether an approval is required.
        :param _builtins.bool approval_required_for_extension: Whether an approval is required to grant extension. Same approval settings used to approve initial access will apply.
        ...
        :param _builtins.bool requestor_justification_required: Whether a requestor is required to provide a justification to request an access package. Justification is visible to approvers and the requestor.
        """
    ...
    def approval_required_for_extension(self) -> Optional[_builtins.bool]:
        """
    ...
    def requestor_justification_required(self) -> Optional[_builtins.bool]:
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStage(dict):
    ...
    def __init__(__self__, *,
                 approval_timeout_in_days: _builtins.int,
                 alternative_approval_enabled: Optional[_builtins.bool] = None,
                 ...
                 approver_justification_required: Optional[_builtins.bool] = None,
                 enable_alternative_approval_in_days: Optional[_builtins.int] = None,
        ...
        """
        :param _builtins.int approval_timeout_in_days: Decision must be made in how many days? If a request is not approved within this time period after it is made, it will be automatically rejected
        :param _builtins.bool alternative_approval_enabled: If no action taken, forward to alternate approvers?
        ...
        :param _builtins.bool approver_justification_required: Whether an approver must provide a justification for their decision. Justification is visible to other approvers and the requestor
        :param _builtins.int enable_alternative_approval_in_days: Forward to alternate approver(s) after how many days?
    ...
    def approval_timeout_in_days(self) -> _builtins.int:
        """
    ...
    def alternative_approval_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def approver_justification_required(self) -> Optional[_builtins.bool]:
        """
    ...
    def enable_alternative_approval_in_days(self) -> Optional[_builtins.int]:
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApprover(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str subject_type: Type of users
        :param _builtins.bool backup: For a user in an approval stage, this property indicates whether the user is a backup fallback approver
        :param _builtins.str object_id: The object ID of the subject
        """
...
class AccessPackageAssignmentPolicyAssignmentReviewSettings(dict):
    ...
    def __init__(__self__, *,
                 access_recommendation_enabled: Optional[_builtins.bool] = None,
                 access_review_timeout_behavior: Optional[_builtins.str] = None,
                 approver_justification_required: Optional[_builtins.bool] = None,
                 duration_in_days: Optional[_builtins.int] = None,
                 enabled: Optional[_builtins.bool] = None,
                 review_frequency: Optional[_builtins.str] = None,
                 review_type: Optional[_builtins.str] = None,
                 reviewers: Optional[Sequence['outputs.AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewer']] = None,
                 starting_on: Optional[_builtins.str] = None):
        """
        :param _builtins.bool access_recommendation_enabled: Whether to show the reviewer decision helpers. If enabled, system recommendations based on users' access information will be shown to the reviewers. The reviewer will be recommended to approve the review if the user has signed-in at least once during the last 30 days. The reviewer will be recommended to deny the review if the user has not signed-in during the last 30 days.
        :param _builtins.str access_review_timeout_behavior: Specifies the actions the system takes if reviewers don't respond in time. Valid values are `keepAccess`, `removeAccess`, or `acceptAccessRecommendation`.
        :param _builtins.bool approver_justification_required: Whether a reviewer needs to provide a justification for their decision. Justification is visible to other reviewers and the requestor.
        :param _builtins.int duration_in_days: How many days each occurrence of the access review series will run.
        :param _builtins.bool enabled: Whether to enable assignment review.
        :param _builtins.str review_frequency: This will determine how often the access review campaign runs, valid values are `weekly`, `monthly`, `quarterly`, `halfyearly`, or `annual`.
        :param _builtins.str review_type: Self-review or specific reviewers. Valid values are `Manager`, `Reviewers`, or `Self`.
        ...
        :param _builtins.str starting_on: This is the date the access review campaign will start on, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z), default is now. Once an access review has been created, you cannot update its start date
        """
    ...
    def access_recommendation_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def access_review_timeout_behavior(self) -> Optional[_builtins.str]:
        """
    ...
    def review_frequency(self) -> Optional[_builtins.str]:
        """
    ...
    def review_type(self) -> Optional[_builtins.str]:
        """
    ...
    def starting_on(self) -> Optional[_builtins.str]:
        """
...
class AccessPackageAssignmentPolicyQuestion(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.bool required: Whether this question is required.
        :param _builtins.int sequence: The sequence number of this question.
        """
...
class AccessPackageAssignmentPolicyQuestionChoice(dict):
    ...
    def __init__(__self__, *,
                 actual_value: _builtins.str,
                 display_value: 'outputs.AccessPackageAssignmentPolicyQuestionChoiceDisplayValue'):
        """
        :param _builtins.str actual_value: The actual value of this choice
    ...
    def actual_value(self) -> _builtins.str:
        """
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str default_text: The default text of this question
    ...
    def default_text(self) -> _builtins.str:
        """
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueLocalizedText(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str content: The localized content of this question
        :param _builtins.str language_code: The language code of this question content
        """
...
class AccessPackageAssignmentPolicyRequestorSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 requests_accepted: Optional[_builtins.bool] = None,
    ...
    def requests_accepted(self) -> Optional[_builtins.bool]:
        """
...
class ApplicationApi(dict):
    ...
    def __init__(__self__, *,
                 known_client_applications: Optional[Sequence[_builtins.str]] = None,
                 mapped_claims_enabled: Optional[_builtins.bool] = None,
                 oauth2_permission_scopes: Optional[Sequence['outputs.ApplicationApiOauth2PermissionScope']] = None,
                 requested_access_token_version: Optional[_builtins.int] = None):
        """
        :param Sequence[_builtins.str] known_client_applications: A set of client IDs, used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        :param _builtins.bool mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key. Defaults to `false`.
        ...
        :param _builtins.int requested_access_token_version: The access token version expected by this resource. Must be one of `1` or `2`, and must be `2` when `sign_in_audience` is either `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount` Defaults to `1`.
        """
    ...
    def known_client_applications(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def mapped_claims_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def requested_access_token_version(self) -> Optional[_builtins.int]:
        """
...
class ApplicationApiOauth2PermissionScope(dict):
    ...
    def __init__(__self__, *,
                 id: _builtins.str,
                 admin_consent_description: Optional[_builtins.str] = None,
                 admin_consent_display_name: Optional[_builtins.str] = None,
                 enabled: Optional[_builtins.bool] = None,
                 type: Optional[_builtins.str] = None,
                 user_consent_description: Optional[_builtins.str] = None,
                 user_consent_display_name: Optional[_builtins.str] = None,
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str id: The unique identifier of the delegated permission. Must be a valid UUID.
        ...
        :param _builtins.str admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        :param _builtins.str admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        :param _builtins.bool enabled: Determines if the permission scope is enabled. Defaults to `true`.
    ...
    def admin_consent_description(self) -> Optional[_builtins.str]:
        """
    ...
    def admin_consent_display_name(self) -> Optional[_builtins.str]:
        """
    ...
    def user_consent_description(self) -> Optional[_builtins.str]:
        """
    ...
    def user_consent_display_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationAppRole(dict):
    ...
    def __init__(__self__, *,
                 allowed_member_types: Sequence[_builtins.str],
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups by setting to `User`, or to other applications (that are accessing this application in a standalone scenario) by setting to `Application`, or to both.
        :param _builtins.str description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences.
        :param _builtins.str display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param _builtins.str id: The unique identifier of the app role. Must be a valid UUID.
    ...
    def allowed_member_types(self) -> Sequence[_builtins.str]:
        """
...
class ApplicationFeatureTag(dict):
    ...
    def __init__(__self__, *,
                 custom_single_sign_on: Optional[_builtins.bool] = None,
                 enterprise: Optional[_builtins.bool] = None,
                 gallery: Optional[_builtins.bool] = None,
                 hide: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param _builtins.bool enterprise: Whether this application represents an Enterprise Application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param _builtins.bool gallery: Whether this application represents a gallery application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param _builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
    ...
    def custom_single_sign_on(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def enterprise(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def gallery(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def hide(self) -> Optional[_builtins.bool]:
        """
...
class ApplicationOptionalClaimsAccessToken(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 additional_properties: Optional[Sequence[_builtins.str]] = None,
                 essential: Optional[_builtins.bool] = None,
                 source: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the optional claim.
        :param Sequence[_builtins.str] additional_properties: List of additional properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim. Possible values are: `cloud_displayname`, `dns_domain_and_sam_account_name`, `emit_as_roles`, `include_externally_authenticated_upn_without_hash`, `include_externally_authenticated_upn`, `max_size_limit`, `netbios_domain_and_sam_account_name`, `on_premise_security_identifier`, `sam_account_name`, and `use_guid`.
        :param _builtins.bool essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param _builtins.str source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
    ...
    def additional_properties(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ApplicationPassword(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str display_name: A display name for the password. Changing this field forces a new resource to be created.
        :param _builtins.str end_date: The end date until which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
        :param _builtins.str key_id: (Required) The unique key ID for the generated password.
        :param _builtins.str start_date: The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
        :param _builtins.str value: (Required) The generated password for the application.
        """
        pulumi.set(__self__, "display_name", display_name)
...
class ApplicationPublicClient(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` or `ms-appx-web` URL.
        """
...
class ApplicationRequiredResourceAccess(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_app_id: The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
    ...
    def resource_app_id(self) -> _builtins.str:
        """
...
class ApplicationRequiredResourceAccessResourceAccess(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.str id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param _builtins.str type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ApplicationSinglePageApplication(dict):
    ...
    def __init__(__self__, *,
                 redirect_uris: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` URL.
        """
        if redirect_uris is not None:
            pulumi.set(__self__, "redirect_uris", redirect_uris)
...
class ApplicationWeb(dict):
    ...
    def __init__(__self__, *,
                 homepage_url: Optional[_builtins.str] = None,
                 implicit_grant: Optional['outputs.ApplicationWebImplicitGrant'] = None,
                 logout_url: Optional[_builtins.str] = None,
                 redirect_uris: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str homepage_url: Home page or landing page of the application.
        :param 'ApplicationWebImplicitGrantArgs' implicit_grant: An `implicit_grant` block as documented above.
        :param _builtins.str logout_url: The URL that will be used by Microsoft's authorization service to sign out a user using front-channel, back-channel or SAML logout protocols.
        :param Sequence[_builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `http` URL or a URN.
        """
    ...
    def homepage_url(self) -> Optional[_builtins.str]:
        """
...
class ApplicationWebImplicitGrant(dict):
    ...
    def __init__(__self__, *,
                 access_token_issuance_enabled: Optional[_builtins.bool] = None,
                 id_token_issuance_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow.
        :param _builtins.bool id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    def access_token_issuance_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def id_token_issuance_enabled(self) -> Optional[_builtins.bool]:
        """
...
class ConditionalAccessPolicyConditions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 service_principal_risk_levels: Optional[Sequence[_builtins.str]] = None,
                 sign_in_risk_levels: Optional[Sequence[_builtins.str]] = None,
                 user_risk_levels: Optional[Sequence[_builtins.str]] = None):
        """
        ...
        :param Sequence[_builtins.str] user_risk_levels: A list of user risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def client_app_types(self) -> Sequence[_builtins.str]:
        """
    ...
    def insider_risk_levels(self) -> Optional[_builtins.str]:
        """
    ...
    def service_principal_risk_levels(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def sign_in_risk_levels(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def user_risk_levels(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsApplications(dict):
    ...
    def __init__(__self__, *,
                 excluded_applications: Optional[Sequence[_builtins.str]] = None,
                 filter: Optional['outputs.ConditionalAccessPolicyConditionsApplicationsFilter'] = None,
                 included_applications: Optional[Sequence[_builtins.str]] = None,
                 included_user_actions: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] excluded_applications: A list of application IDs explicitly excluded from the policy. Can also be set to `Office365`.
        :param 'ConditionalAccessPolicyConditionsApplicationsFilterArgs' filter: A `filter` block as documented below.
        ...
        :param Sequence[_builtins.str] included_applications: A list of application IDs the policy applies to, unless explicitly excluded (in `excluded_applications`). Can also be set to `All`, `None` or `Office365`. Cannot be specified with `included_user_actions`. One of `included_applications` or `included_user_actions` must be specified.
        :param Sequence[_builtins.str] included_user_actions: A list of user actions to include. Supported values are `urn:user:registerdevice` and `urn:user:registersecurityinfo`. Cannot be specified with `included_applications`. One of `included_applications` or `included_user_actions` must be specified.
        """
    ...
    def excluded_applications(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> Optional['outputs.ConditionalAccessPolicyConditionsApplicationsFilter']:
        """
    ...
    def included_applications(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def included_user_actions(self) -> Optional[Sequence[_builtins.str]]:
        """
...
@pulumi.output_type
class ConditionalAccessPolicyConditionsApplicationsFilter(dict):
    def __init__(__self__, *,
                 mode: _builtins.str,
                 rule: _builtins.str):
        """
...
class ConditionalAccessPolicyConditionsClientApplications(dict):
    ...
    def excluded_service_principals(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsLocations(dict):
    ...
    def __init__(__self__, *,
                 included_locations: Sequence[_builtins.str],
                 excluded_locations: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] included_locations: A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        :param Sequence[_builtins.str] excluded_locations: A list of location IDs excluded from scope of policy. Can also be set to `AllTrusted`.
        """
    ...
    def included_locations(self) -> Sequence[_builtins.str]:
        """
    ...
    def excluded_locations(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsPlatforms(dict):
    ...
    def __init__(__self__, *,
                 included_platforms: Sequence[_builtins.str],
                 excluded_platforms: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] included_platforms: A list of platforms the policy applies to, unless explicitly excluded. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        :param Sequence[_builtins.str] excluded_platforms: A list of platforms explicitly excluded from the policy. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def included_platforms(self) -> Sequence[_builtins.str]:
        """
    ...
    def excluded_platforms(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsUsers(dict):
    ...
    def __init__(__self__, *,
                 excluded_groups: Optional[Sequence[_builtins.str]] = None,
                 ...
                 excluded_roles: Optional[Sequence[_builtins.str]] = None,
                 excluded_users: Optional[Sequence[_builtins.str]] = None,
                 included_groups: Optional[Sequence[_builtins.str]] = None,
                 ...
                 included_roles: Optional[Sequence[_builtins.str]] = None,
                 included_users: Optional[Sequence[_builtins.str]] = None):
        """
    ...
    def excluded_groups(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def excluded_users(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def included_groups(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def included_users(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUser(dict):
    ...
    def __init__(__self__, *,
                 guest_or_external_user_types: Sequence[_builtins.str],
        ...
        """
        :param Sequence[_builtins.str] guest_or_external_user_types: A list of guest or external user types. Possible values are: `b2bCollaborationGuest`, `b2bCollaborationMember`, `b2bDirectConnectUser`, `internalGuest`, `none`, `otherExternalUser`, `serviceProvider`, `unknownFutureValue`.
    ...
    def guest_or_external_user_types(self) -> Sequence[_builtins.str]:
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserExternalTenant(dict):
    ...
    def __init__(__self__, *,
                 membership_kind: _builtins.str,
                 members: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str membership_kind: The external tenant membership kind. Possible values are: `all`, `enumerated`, `unknownFutureValue`.
        :param Sequence[_builtins.str] members: A list tenant IDs. Can only be specified if `membership_kind` is `enumerated`.
        """
    ...
    def membership_kind(self) -> _builtins.str:
        """
...
class ConditionalAccessPolicyGrantControls(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authentication_strength_policy_id: Optional[_builtins.str] = None,
                 built_in_controls: Optional[Sequence[_builtins.str]] = None,
                 custom_authentication_factors: Optional[Sequence[_builtins.str]] = None,
                 terms_of_uses: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str operator: Defines the relationship of the grant controls. Possible values are: `AND`, `OR`.
        :param _builtins.str authentication_strength_policy_id: ID of an Authentication Strength Policy to use in this policy. When using a hard-coded ID, the UUID value should be prefixed with: `/policies/authenticationStrengthPolicies/`.
        :param Sequence[_builtins.str] built_in_controls: List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        :param Sequence[_builtins.str] custom_authentication_factors: List of custom controls IDs required by the policy.
        :param Sequence[_builtins.str] terms_of_uses: List of terms of use IDs required by the policy.
    ...
    def authentication_strength_policy_id(self) -> Optional[_builtins.str]:
        """
    ...
    def built_in_controls(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def custom_authentication_factors(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def terms_of_uses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ConditionalAccessPolicySessionControls(dict):
    ...
    def __init__(__self__, *,
                 application_enforced_restrictions_enabled: Optional[_builtins.bool] = None,
                 cloud_app_security_policy: Optional[_builtins.str] = None,
                 disable_resilience_defaults: Optional[_builtins.bool] = None,
                 persistent_browser_mode: Optional[_builtins.str] = None,
                 sign_in_frequency: Optional[_builtins.int] = None,
                 sign_in_frequency_authentication_type: Optional[_builtins.str] = None,
                 sign_in_frequency_interval: Optional[_builtins.str] = None,
                 sign_in_frequency_period: Optional[_builtins.str] = None):
        """
        :param _builtins.bool application_enforced_restrictions_enabled: Whether application enforced restrictions are enabled. Defaults to `false`.
               
               > Only Office 365, Exchange Online and Sharepoint Online support application enforced restrictions.
        :param _builtins.str cloud_app_security_policy: Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        :param _builtins.bool disable_resilience_defaults: Disables [resilience defaults](https://learn.microsoft.com/en-us/azure/active-directory/conditional-access/resilience-defaults). Defaults to `false`.
        :param _builtins.str persistent_browser_mode: Session control to define whether to persist cookies. Possible values are: `always` or `never`.
        :param _builtins.int sign_in_frequency: Number of days or hours to enforce sign-in frequency. Required when `sign_in_frequency_period` is specified.
        :param _builtins.str sign_in_frequency_authentication_type: Authentication type for enforcing sign-in frequency. Possible values are: `primaryAndSecondaryAuthentication` or `secondaryAuthentication`. Defaults to `primaryAndSecondaryAuthentication`.
        :param _builtins.str sign_in_frequency_interval: The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        :param _builtins.str sign_in_frequency_period: The time period to enforce sign-in frequency. Possible values are: `hours` or `days`. Required when `sign_in_frequency_period` is specified.
        """
    ...
    def application_enforced_restrictions_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def cloud_app_security_policy(self) -> Optional[_builtins.str]:
        """
    ...
    def disable_resilience_defaults(self) -> Optional[_builtins.bool]:
        """
    ...
    def persistent_browser_mode(self) -> Optional[_builtins.str]:
        """
    ...
    def sign_in_frequency(self) -> Optional[_builtins.int]:
        """
    ...
    def sign_in_frequency_authentication_type(self) -> Optional[_builtins.str]:
        """
    ...
    def sign_in_frequency_interval(self) -> Optional[_builtins.str]:
        """
    ...
    def sign_in_frequency_period(self) -> Optional[_builtins.str]:
        """
...
class CustomDirectoryRolePermission(dict):
    ...
    def __init__(__self__, *,
                 allowed_resource_actions: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] allowed_resource_actions: A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
        pulumi.set(__self__, "allowed_resource_actions", allowed_resource_actions)

    @_builtins.property
    @pulumi.getter(name="allowedResourceActions")
    def allowed_resource_actions(self) -> Sequence[_builtins.str]:
        """
...
class GroupDynamicMembership(dict):
    def __init__(__self__, *,
                 ...
                 rule: _builtins.str):
        """
        :param _builtins.bool enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param _builtins.str rule: The rule that determines membership of this group. For more information, see official documentation on [membership rules syntax](https://docs.microsoft.com/en-gb/azure/active-directory/enterprise-users/groups-dynamic-membership).
...
class GroupRoleManagementPolicyActivationRules(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maximum_duration: Optional[_builtins.str] = None,
                 require_approval: Optional[_builtins.bool] = None,
                 require_justification: Optional[_builtins.bool] = None,
                 require_multifactor_authentication: Optional[_builtins.bool] = None,
                 require_ticket_info: Optional[_builtins.bool] = None,
                 required_conditional_access_authentication_context: Optional[_builtins.str] = None):
        """
        :param 'GroupRoleManagementPolicyActivationRulesApprovalStageArgs' approval_stage: An `approval_stage` block as defined below.
        :param _builtins.str maximum_duration: The maximum length of time an activated role can be valid, in an ISO8601 Duration format (e.g. `PT8H`). Valid range is `PT30M` to `PT23H30M`, in 30 minute increments, or `PT1D`.
    ...
    def require_approval(self) -> Optional[_builtins.bool]:
        """
    ...
    def require_justification(self) -> Optional[_builtins.bool]:
        """
    ...
    def require_multifactor_authentication(self) -> Optional[_builtins.bool]:
        """
    ...
    def required_conditional_access_authentication_context(self) -> Optional[_builtins.str]:
        """
...
class GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApprover(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[_builtins.str] = None):
        """
        :param _builtins.str object_id: The ID of the object which will act as an approver.
        :param _builtins.str type: The type of object acting as an approver. Possible options are `singleUser` and `groupMembers`.
        """
        pulumi.set(__self__, "object_id", object_id)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class GroupRoleManagementPolicyActiveAssignmentRules(dict):
    ...
    def __init__(__self__, *,
                 expiration_required: Optional[_builtins.bool] = None,
                 expire_after: Optional[_builtins.str] = None,
                 require_justification: Optional[_builtins.bool] = None,
                 require_multifactor_authentication: Optional[_builtins.bool] = None,
                 require_ticket_info: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool expiration_required: Must an assignment have an expiry date. `false` allows permanent assignment.
        :param _builtins.str expire_after: The maximum length of time an assignment can be valid, as an ISO8601 duration. Permitted values: `P15D`, `P30D`, `P90D`, `P180D`, or `P365D`.
        :param _builtins.bool require_justification: Is a justification required to create new assignments.
        :param _builtins.bool require_multifactor_authentication: Is multi-factor authentication required to create new assignments.
        :param _builtins.bool require_ticket_info: Is ticket information required to create new assignments.
    ...
    def expiration_required(self) -> Optional[_builtins.bool]:
        """
...
class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotifications(dict):
    ...
    def __init__(__self__, *,
                 default_recipients: _builtins.bool,
                 notification_level: _builtins.str,
                 additional_recipients: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool default_recipients: Whether the default recipients are notified
        :param _builtins.str notification_level: What level of notifications are sent
        :param Sequence[_builtins.str] additional_recipients: The additional recipients to notify
        """
    ...
    def default_recipients(self) -> _builtins.bool:
        """
    ...
    def notification_level(self) -> _builtins.str:
        """
...
class InvitationMessage(dict):
    ...
    def __init__(__self__, *,
                 additional_recipients: Optional[_builtins.str] = None,
                 body: Optional[_builtins.str] = None,
                 language: Optional[_builtins.str] = None):
        """
        :param _builtins.str additional_recipients: Email addresses of additional recipients the invitation message should be sent to. Only 1 additional recipient is currently supported by Azure.
        :param _builtins.str body: Customized message body you want to send if you don't want to send the default message. Cannot be specified with `language`.
        :param _builtins.str language: The language you want to send the default message in. The value specified must be in ISO 639 format. Defaults to `en-US`. Cannot be specified with `body`.
        """
        if additional_recipients is not None:
            pulumi.set(__self__, "additional_recipients", additional_recipients)
        if body is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="additionalRecipients")
    def additional_recipients(self) -> Optional[_builtins.str]:
        """
...
class NamedLocationCountry(dict):
    ...
    def __init__(__self__, *,
                 countries_and_regions: Sequence[_builtins.str],
                 country_lookup_method: Optional[_builtins.str] = None,
                 include_unknown_countries_and_regions: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] countries_and_regions: List of countries and/or regions in two-letter format specified by ISO 3166-2.
        :param _builtins.str country_lookup_method: Method of detecting country the user is located in. Possible values are `clientIpAddress` for IP-based location and `authenticatorAppGps` for Authenticator app GPS-based location.  Defaults to `clientIpAddress`.
        :param _builtins.bool include_unknown_countries_and_regions: Whether IP addresses that don't map to a country or region should be included in the named location. Defaults to `false`.
        """
    ...
    def countries_and_regions(self) -> Sequence[_builtins.str]:
        """
    ...
    def country_lookup_method(self) -> Optional[_builtins.str]:
        """
    ...
    def include_unknown_countries_and_regions(self) -> Optional[_builtins.bool]:
        """
...
class NamedLocationIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] ip_ranges: List of IP address ranges in IPv4 CIDR format (e.g. `1.2.3.4/32`) or any allowable IPv6 format from IETF RFC596. Each CIDR prefix must be `/8` or larger.
        :param _builtins.bool trusted: Whether the named location is trusted. Defaults to `false`.
        """
...
class ServicePrincipalAppRole(dict):
    ...
    def __init__(__self__, *,
                 allowed_member_types: Optional[Sequence[_builtins.str]] = None,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are: `User` and `Application`, or both.
        :param _builtins.str description: A description of the service principal provided for internal end-users.
        :param _builtins.str display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param _builtins.bool enabled: Specifies whether the permission scope is enabled.
        :param _builtins.str id: The unique identifier of the delegated permission.
        :param _builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="allowedMemberTypes")
    def allowed_member_types(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ServicePrincipalFeature(dict):
    ...
    def __init__(__self__, *,
                 custom_single_sign_on_app: Optional[_builtins.bool] = None,
                 enterprise_application: Optional[_builtins.bool] = None,
                 gallery_application: Optional[_builtins.bool] = None,
                 visible_to_users: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool custom_single_sign_on_app: Whether this service principal represents a custom SAML application
        :param _builtins.bool enterprise_application: Whether this service principal represents an Enterprise Application
        :param _builtins.bool gallery_application: Whether this service principal represents a gallery application
        :param _builtins.bool visible_to_users: Whether this app is visible to users in My Apps and Office 365 Launcher
        """
    ...
    def custom_single_sign_on_app(self) -> Optional[_builtins.bool]:
        """
    ...
    def enterprise_application(self) -> Optional[_builtins.bool]:
        """
    ...
    def gallery_application(self) -> Optional[_builtins.bool]:
        """
    ...
    def visible_to_users(self) -> Optional[_builtins.bool]:
        """
...
class ServicePrincipalFeatureTag(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hide: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool custom_single_sign_on: Whether this service principal represents a custom SAML application. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param _builtins.bool enterprise: Whether this service principal represents an Enterprise Application. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param _builtins.bool gallery: Whether this service principal represents a gallery application. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param _builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
...
class ServicePrincipalOauth2PermissionScope(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enabled: Specifies whether the permission scope is enabled.
        :param _builtins.str id: The unique identifier of the delegated permission.
        :param _builtins.str type: Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves, or whether an administrator should be required for consent to the permissions. Possible values are `User` or `Admin`.
        :param _builtins.str user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param _builtins.str user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
        :param _builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
...
class ServicePrincipalSamlSingleSignOn(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str relay_state: The relative URI the service provider would redirect to after completion of the single sign-on flow.
        """
...
class SynchronizationJobProvisionOnDemandParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str rule_id: The identifier of the synchronization rule to be applied. This rule ID is defined in the schema for a given synchronization job or template.
...
class SynchronizationJobProvisionOnDemandParameterSubject(dict):
    ...
    def object_type_name(self) -> _builtins.str:
        """
...
class SynchronizationJobSchedule(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str expiration: Date and time when this job will expire, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).
        :param _builtins.str interval: The interval between synchronization iterations ISO8601. E.g. PT40M run every 40 minutes.
        :param _builtins.str state: State of the job.
        """
...
class SynchronizationSecretCredential(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str key: The key of the secret.
...
class GetApplicationApiResult(dict):
    def __init__(__self__, *,
                 known_client_applications: Sequence[_builtins.str],
                 mapped_claims_enabled: _builtins.bool,
                 oauth2_permission_scopes: Sequence['outputs.GetApplicationApiOauth2PermissionScopeResult'],
                 requested_access_token_version: _builtins.int):
        """
        :param Sequence[_builtins.str] known_client_applications: A set of application IDs (client IDs), used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        :param _builtins.bool mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key.
        ...
        :param _builtins.int requested_access_token_version: The access token version expected by this resource. Possible values are `1` or `2`.
        """
        pulumi.set(__self__, "known_client_applications", known_client_applications)
        pulumi.set(__self__, "mapped_claims_enabled", mapped_claims_enabled)
        pulumi.set(__self__, "oauth2_permission_scopes", oauth2_permission_scopes)
    ...
    @_builtins.property
    @pulumi.getter(name="knownClientApplications")
    def known_client_applications(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mappedClaimsEnabled")
    def mapped_claims_enabled(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requestedAccessTokenVersion")
    def requested_access_token_version(self) -> _builtins.int:
        """
...
class GetApplicationApiOauth2PermissionScopeResult(dict):
    def __init__(__self__, *,
                 admin_consent_description: _builtins.str,
                 admin_consent_display_name: _builtins.str,
                 enabled: _builtins.bool,
                 id: _builtins.str,
                 type: _builtins.str,
                 user_consent_description: _builtins.str,
                 user_consent_display_name: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.str admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        :param _builtins.str admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        :param _builtins.bool enabled: Determines if the app role is enabled.
        :param _builtins.str id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param _builtins.str type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        :param _builtins.str user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param _builtins.str user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
    ...
    @_builtins.property
    @pulumi.getter(name="adminConsentDescription")
    def admin_consent_description(self) -> _builtins.str:
        """
        Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        """
        return pulumi.get(self, "admin_consent_description")
    ...
    @_builtins.property
    @pulumi.getter(name="adminConsentDisplayName")
    def admin_consent_display_name(self) -> _builtins.str:
        """
        Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        """
        return pulumi.get(self, "admin_consent_display_name")
    ...
    @_builtins.property
    @pulumi.getter(name="userConsentDescription")
    def user_consent_description(self) -> _builtins.str:
        """
        Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        """
        return pulumi.get(self, "user_consent_description")
    ...
    @_builtins.property
    @pulumi.getter(name="userConsentDisplayName")
    def user_consent_display_name(self) -> _builtins.str:
        """
        Display name for the delegated permission that appears in the end user consent experience.
        """
        return pulumi.get(self, "user_consent_display_name")
...
class GetApplicationAppRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param Sequence[_builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are `User` or `Application`, or both.
        :param _builtins.str description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences.
...
class GetApplicationFeatureTagResult(dict):
    def __init__(__self__, *,
                 ...
                 hide: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals.
        :param _builtins.bool enterprise: Whether this application represents an Enterprise Application for linked service principals.
        :param _builtins.bool gallery: Whether this application represents a gallery application for linked service principals.
        :param _builtins.bool hide: Whether this app is visible to users in My Apps and Office 365 Launcher.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
        if enterprise is not None:
...
class GetApplicationOptionalClaimAccessTokenResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the optional claim.
        :param Sequence[_builtins.str] additional_properties: List of Additional Properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim.
        :param _builtins.bool essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param _builtins.str source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
        pulumi.set(__self__, "name", name)
...
class GetApplicationPublicClientResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] redirect_uris: A list of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent.
        """
        pulumi.set(__self__, "redirect_uris", redirect_uris)
...
class GetApplicationRequiredResourceAccessResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str resource_app_id: The unique identifier for the resource that the application requires access to. This is the Application ID of the target application.
        """
        pulumi.set(__self__, "resource_accesses", resource_accesses)
        pulumi.set(__self__, "resource_app_id", resource_app_id)
...
class GetApplicationWebImplicitGrantResult(dict):
    def __init__(__self__, *,
                 access_token_issuance_enabled: _builtins.bool,
                 id_token_issuance_enabled: _builtins.bool):
        """
        :param _builtins.bool access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow.
        :param _builtins.bool id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="accessTokenIssuanceEnabled")
    def access_token_issuance_enabled(self) -> _builtins.bool:
        """
        Whether this web application can request an access token using OAuth 2.0 implicit flow.
        """
        return pulumi.get(self, "access_token_issuance_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="idTokenIssuanceEnabled")
    def id_token_issuance_enabled(self) -> _builtins.bool:
        """
        Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
        return pulumi.get(self, "id_token_issuance_enabled")
...
class GetDirectoryRoleTemplatesRoleTemplateResult(dict):
    def __init__(__self__, *,
                 ...
                 object_id: _builtins.str):
        """
        :param _builtins.str description: The description of the directory role template.
        :param _builtins.str display_name: The display name of the directory role template.
        :param _builtins.str object_id: The object ID of the directory role template.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "object_id", object_id)
...
class GetDirectoryRolesRoleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: The description of the directory role.
        :param _builtins.str display_name: The display name of the directory role.
        :param _builtins.str object_id: The object ID of the directory role.
        :param _builtins.str template_id: The template ID of the directory role.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "object_id", object_id)
...
class GetDomainsDomainResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str authentication_type: The authentication type of the domain. Possible values include `Managed` or `Federated`.
        :param _builtins.bool default: Whether this is the default domain that is used for user creation.
        :param _builtins.str domain_name: The name of the domain.
        :param _builtins.bool initial: Whether this is the initial domain created by Azure Active Directory.
        :param _builtins.bool root: Whether the domain is a verified root domain (not a subdomain).
        :param Sequence[_builtins.str] supported_services: A list of capabilities / services supported by the domain. Possible values include `Email`, `Sharepoint`, `EmailInternalRelayOnly`, `OfficeCommunicationsOnline`, `SharePointDefaultDomain`, `FullRedelegation`, `SharePointPublic`, `OrgIdAuthentication`, `Yammer` and `Intune`.
        :param _builtins.bool verified: Whether the domain has completed domain ownership verification.
        """
    ...
    def admin_managed(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def initial(self) -> _builtins.bool:
        """
    ...
    def supported_services(self) -> Sequence[_builtins.str]:
        """
...
class GetGroupDynamicMembershipResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param _builtins.str rule: The rule that determines membership of this group.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "rule", rule)
...
class GetNamedLocationCountryResult(dict):
    def __init__(__self__, *,
                 countries_and_regions: Sequence[_builtins.str],
                 country_lookup_method: _builtins.str,
                 include_unknown_countries_and_regions: _builtins.bool):
        pulumi.set(__self__, "countries_and_regions", countries_and_regions)
        pulumi.set(__self__, "country_lookup_method", country_lookup_method)
        pulumi.set(__self__, "include_unknown_countries_and_regions", include_unknown_countries_and_regions)
    ...
    @_builtins.property
    @pulumi.getter(name="countryLookupMethod")
    def country_lookup_method(self) -> _builtins.str:
        return pulumi.get(self, "country_lookup_method")

    @_builtins.property
    @pulumi.getter(name="includeUnknownCountriesAndRegions")
    def include_unknown_countries_and_regions(self) -> _builtins.bool:
        return pulumi.get(self, "include_unknown_countries_and_regions")
...
class GetServicePrincipalAppRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param Sequence[_builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in daemon service scenarios). Possible values are: `User` and `Application`, or both.
        :param _builtins.str description: Permission help text that appears in the admin app assignment and consent experiences.
        :param _builtins.str display_name: The display name of the application associated with this service principal.
        :param _builtins.bool enabled: Determines if the permission scope is enabled.
        :param _builtins.str id: The unique identifier of the delegated permission. Must be a valid UUID.
        :param _builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
        pulumi.set(__self__, "allowed_member_types", allowed_member_types)
...
class GetServicePrincipalFeatureResult(dict):
    def __init__(__self__, *,
                 custom_single_sign_on_app: _builtins.bool,
                 enterprise_application: _builtins.bool,
                 gallery_application: _builtins.bool,
                 visible_to_users: _builtins.bool):
        """
        :param _builtins.bool custom_single_sign_on_app: Whether this service principal represents a custom SAML application.
        :param _builtins.bool enterprise_application: Whether this service principal represents an Enterprise Application.
        :param _builtins.bool gallery_application: Whether this service principal represents a gallery application.
    ...
    @_builtins.property
    @pulumi.getter(name="customSingleSignOnApp")
    def custom_single_sign_on_app(self) -> _builtins.bool:
        """
        Whether this service principal represents a custom SAML application.
        """
        return pulumi.get(self, "custom_single_sign_on_app")
    ...
    @_builtins.property
    @pulumi.getter(name="enterpriseApplication")
    def enterprise_application(self) -> _builtins.bool:
        """
        Whether this service principal represents an Enterprise Application.
        """
        return pulumi.get(self, "enterprise_application")
    ...
    @_builtins.property
    @pulumi.getter(name="galleryApplication")
    def gallery_application(self) -> _builtins.bool:
        """
        Whether this service principal represents a gallery application.
        """
        return pulumi.get(self, "gallery_application")
    ...
    @_builtins.property
    @pulumi.getter(name="visibleToUsers")
    def visible_to_users(self) -> _builtins.bool:
        """
        Whether this app is visible to users in My Apps and Office 365 Launcher.
        """
        return pulumi.get(self, "visible_to_users")
...
class GetServicePrincipalFeatureTagResult(dict):
    def __init__(__self__, *,
                 custom_single_sign_on: _builtins.bool,
                 enterprise: _builtins.bool,
                 gallery: _builtins.bool,
                 hide: _builtins.bool):
        """
        :param _builtins.bool custom_single_sign_on: Whether this service principal represents a custom SAML application
        :param _builtins.bool enterprise: Whether this service principal represents an Enterprise Application
        :param _builtins.bool gallery: Whether this service principal represents a gallery application
        :param _builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher
        """
        pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
        pulumi.set(__self__, "enterprise", enterprise)
        pulumi.set(__self__, "gallery", gallery)
    ...
    @_builtins.property
    @pulumi.getter(name="customSingleSignOn")
    def custom_single_sign_on(self) -> _builtins.bool:
        """
        Whether this service principal represents a custom SAML application
        """
        return pulumi.get(self, "custom_single_sign_on")
    ...
    @_builtins.property
    @pulumi.getter
    def gallery(self) -> _builtins.bool:
        """
        Whether this service principal represents a gallery application
        """
        return pulumi.get(self, "gallery")
...
class GetServicePrincipalsServicePrincipalResult(dict):
    def __init__(__self__, *,
                 account_enabled: _builtins.bool,
                 app_role_assignment_required: _builtins.bool,
                 application_tenant_id: _builtins.str,
                 client_id: _builtins.str,
                 display_name: _builtins.str,
                 object_id: _builtins.str,
                 preferred_single_sign_on_mode: _builtins.str,
                 saml_metadata_url: _builtins.str,
                 service_principal_names: Sequence[_builtins.str],
                 sign_in_audience: _builtins.str,
                 tags: Sequence[_builtins.str],
                 type: _builtins.str):
        """
        :param _builtins.bool account_enabled: Whether the service principal account is enabled.
        :param _builtins.bool app_role_assignment_required: Whether this service principal requires an app role assignment to a user or group before Azure AD will issue a user or access token to the application.
        :param _builtins.str application_tenant_id: The tenant ID where the associated application is registered.
        :param _builtins.str client_id: The application ID (client ID) for the associated application
        :param _builtins.str display_name: The display name of the application associated with this service principal.
        :param _builtins.str object_id: The object ID of the service principal.
        :param _builtins.str preferred_single_sign_on_mode: The single sign-on mode configured for this application. Azure AD uses the preferred single sign-on mode to launch the application from Microsoft 365 or the Azure AD My Apps.
        :param _builtins.str saml_metadata_url: The URL where the service exposes SAML metadata for federation.
        :param Sequence[_builtins.str] service_principal_names: A list of identifier URI(s), copied over from the associated application.
        :param _builtins.str sign_in_audience: The Microsoft account types that are supported for the associated application. Possible values include `AzureADMyOrg`, `AzureADMultipleOrgs`, `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount`.
        :param Sequence[_builtins.str] tags: A list of tags applied to the service principal.
        :param _builtins.str type: Identifies whether the service principal represents an application or a managed identity. Possible values include `Application` or `ManagedIdentity`.
        """
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
                 ...
                 mail: _builtins.str,
                 mail_nickname: _builtins.str,
                 object_id: _builtins.str,
                 onpremises_immutable_id: _builtins.str,
                 onpremises_sam_account_name: _builtins.str,
                 onpremises_user_principal_name: _builtins.str,
                 usage_location: _builtins.str,
                 user_principal_name: _builtins.str):
        """
        :param _builtins.bool account_enabled: Whether the account is enabled.
        :param _builtins.str display_name: The display name of the user.
        :param _builtins.str employee_id: The employee identifier assigned to the user by the organisation.
        :param _builtins.str mail: The SMTP email address of the user.
        :param _builtins.str mail_nickname: The email alias of the user.
        :param _builtins.str object_id: The object ID of the user.
        :param _builtins.str onpremises_immutable_id: The value used to associate an on-premises Active Directory user account with their Azure AD user object.
        :param _builtins.str onpremises_sam_account_name: The on-premise SAM account name of the user.
        :param _builtins.str onpremises_user_principal_name: The on-premise user principal name of the user.
        :param _builtins.str usage_location: The usage location of the user.
