...
class AccessPackageAssignmentPolicyApprovalSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 approval_required_for_extension: Optional[builtins.bool] = None,
                 approval_stages: Optional[Sequence['outputs.AccessPackageAssignmentPolicyApprovalSettingsApprovalStage']] = None,
                 requestor_justification_required: Optional[builtins.bool] = None):
        """
        :param builtins.bool approval_required: Whether an approval is required.
        :param builtins.bool approval_required_for_extension: Whether an approval is required to grant extension. Same approval settings used to approve initial access will apply.
        ...
        :param builtins.bool requestor_justification_required: Whether a requestor is required to provide a justification to request an access package. Justification is visible to approvers and the requestor.
        """
    ...
    def approval_required_for_extension(self) -> Optional[builtins.bool]:
        """
    ...
    def requestor_justification_required(self) -> Optional[builtins.bool]:
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStage(dict):
    ...
    def __init__(__self__, *,
                 approval_timeout_in_days: builtins.int,
                 alternative_approval_enabled: Optional[builtins.bool] = None,
                 ...
                 approver_justification_required: Optional[builtins.bool] = None,
                 enable_alternative_approval_in_days: Optional[builtins.int] = None,
        ...
        """
        :param builtins.int approval_timeout_in_days: Decision must be made in how many days? If a request is not approved within this time period after it is made, it will be automatically rejected
        :param builtins.bool alternative_approval_enabled: If no action taken, forward to alternate approvers?
        ...
        :param builtins.bool approver_justification_required: Whether an approver must provide a justification for their decision. Justification is visible to other approvers and the requestor
        :param builtins.int enable_alternative_approval_in_days: Forward to alternate approver(s) after how many days?
    ...
    def approval_timeout_in_days(self) -> builtins.int:
        """
    ...
    def alternative_approval_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def approver_justification_required(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_alternative_approval_in_days(self) -> Optional[builtins.int]:
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApprover(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str subject_type: Type of users
        :param builtins.bool backup: For a user in an approval stage, this property indicates whether the user is a backup fallback approver
        :param builtins.str object_id: The object ID of the subject
        """
...
class AccessPackageAssignmentPolicyAssignmentReviewSettings(dict):
    ...
    def __init__(__self__, *,
                 access_recommendation_enabled: Optional[builtins.bool] = None,
                 access_review_timeout_behavior: Optional[builtins.str] = None,
                 approver_justification_required: Optional[builtins.bool] = None,
                 duration_in_days: Optional[builtins.int] = None,
                 enabled: Optional[builtins.bool] = None,
                 review_frequency: Optional[builtins.str] = None,
                 review_type: Optional[builtins.str] = None,
                 reviewers: Optional[Sequence['outputs.AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewer']] = None,
                 starting_on: Optional[builtins.str] = None):
        """
        :param builtins.bool access_recommendation_enabled: Whether to show the reviewer decision helpers. If enabled, system recommendations based on users' access information will be shown to the reviewers. The reviewer will be recommended to approve the review if the user has signed-in at least once during the last 30 days. The reviewer will be recommended to deny the review if the user has not signed-in during the last 30 days.
        :param builtins.str access_review_timeout_behavior: Specifies the actions the system takes if reviewers don't respond in time. Valid values are `keepAccess`, `removeAccess`, or `acceptAccessRecommendation`.
        :param builtins.bool approver_justification_required: Whether a reviewer needs to provide a justification for their decision. Justification is visible to other reviewers and the requestor.
        :param builtins.int duration_in_days: How many days each occurrence of the access review series will run.
        :param builtins.bool enabled: Whether to enable assignment review.
        :param builtins.str review_frequency: This will determine how often the access review campaign runs, valid values are `weekly`, `monthly`, `quarterly`, `halfyearly`, or `annual`.
        :param builtins.str review_type: Self-review or specific reviewers. Valid values are `Manager`, `Reviewers`, or `Self`.
        ...
        :param builtins.str starting_on: This is the date the access review campaign will start on, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z), default is now. Once an access review has been created, you cannot update its start date
        """
    ...
    def access_recommendation_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def access_review_timeout_behavior(self) -> Optional[builtins.str]:
        """
    ...
    def review_frequency(self) -> Optional[builtins.str]:
        """
    ...
    def review_type(self) -> Optional[builtins.str]:
        """
    ...
    def starting_on(self) -> Optional[builtins.str]:
        """
...
class AccessPackageAssignmentPolicyQuestion(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool required: Whether this question is required.
        :param builtins.int sequence: The sequence number of this question.
        """
...
class AccessPackageAssignmentPolicyQuestionChoice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str actual_value: The actual value of this choice
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_text: The default text of this question
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueLocalizedText(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: The localized content of this question
        :param builtins.str language_code: The language code of this question content
        """
...
class AccessPackageAssignmentPolicyRequestorSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 requests_accepted: Optional[builtins.bool] = None,
    ...
    def requests_accepted(self) -> Optional[builtins.bool]:
        """
...
class ApplicationApi(dict):
    ...
    def __init__(__self__, *,
                 known_client_applications: Optional[Sequence[builtins.str]] = None,
                 mapped_claims_enabled: Optional[builtins.bool] = None,
                 oauth2_permission_scopes: Optional[Sequence['outputs.ApplicationApiOauth2PermissionScope']] = None,
                 requested_access_token_version: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] known_client_applications: A set of client IDs, used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        :param builtins.bool mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key. Defaults to `false`.
        ...
        :param builtins.int requested_access_token_version: The access token version expected by this resource. Must be one of `1` or `2`, and must be `2` when `sign_in_audience` is either `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount` Defaults to `1`.
        """
    ...
    def known_client_applications(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def mapped_claims_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def requested_access_token_version(self) -> Optional[builtins.int]:
        """
...
class ApplicationApiOauth2PermissionScope(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.str,
                 admin_consent_description: Optional[builtins.str] = None,
                 admin_consent_display_name: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None,
                 user_consent_description: Optional[builtins.str] = None,
                 user_consent_display_name: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str id: The unique identifier of the delegated permission. Must be a valid UUID.
        ...
        :param builtins.str admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        :param builtins.str admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        :param builtins.bool enabled: Determines if the permission scope is enabled. Defaults to `true`.
        :param builtins.str type: Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves, or whether an administrator should be required for consent to the permissions. Defaults to `User`. Possible values are `User` or `Admin`.
        :param builtins.str user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param builtins.str user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
        :param builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens
        """
    ...
    def admin_consent_description(self) -> Optional[builtins.str]:
        """
    ...
    def admin_consent_display_name(self) -> Optional[builtins.str]:
        """
    ...
    def user_consent_description(self) -> Optional[builtins.str]:
        """
    ...
    def user_consent_display_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationAppRole(dict):
    ...
    def __init__(__self__, *,
                 allowed_member_types: Sequence[builtins.str],
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups by setting to `User`, or to other applications (that are accessing this application in a standalone scenario) by setting to `Application`, or to both.
        :param builtins.str description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences.
        :param builtins.str display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param builtins.str id: The unique identifier of the app role. Must be a valid UUID.
               
               > **Tip: Generating a UUID for the `id` field** To generate a value for the `id` field in cases where the actual UUID is not important, you can use the `random_uuid` resource. See the application example in the provider repository.
        :param builtins.bool enabled: Determines if the app role is enabled. Defaults to `true`.
        :param builtins.str value: The value that is used for the `roles` claim in ID tokens and OAuth 2.0 access tokens that are authenticating an assigned service or user principal
        """
    ...
    def allowed_member_types(self) -> Sequence[builtins.str]:
        """
...
class ApplicationFeatureTag(dict):
    ...
    def __init__(__self__, *,
                 custom_single_sign_on: Optional[builtins.bool] = None,
                 enterprise: Optional[builtins.bool] = None,
                 gallery: Optional[builtins.bool] = None,
                 hide: Optional[builtins.bool] = None):
        """
        :param builtins.bool custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param builtins.bool enterprise: Whether this application represents an Enterprise Application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param builtins.bool gallery: Whether this application represents a gallery application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
    ...
    def custom_single_sign_on(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def gallery(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def hide(self) -> Optional[builtins.bool]:
        """
...
class ApplicationOptionalClaimsAccessToken(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 additional_properties: Optional[Sequence[builtins.str]] = None,
                 essential: Optional[builtins.bool] = None,
                 source: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the optional claim.
        :param Sequence[builtins.str] additional_properties: List of additional properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim. Possible values are: `cloud_displayname`, `dns_domain_and_sam_account_name`, `emit_as_roles`, `include_externally_authenticated_upn_without_hash`, `include_externally_authenticated_upn`, `max_size_limit`, `netbios_domain_and_sam_account_name`, `on_premise_security_identifier`, `sam_account_name`, and `use_guid`.
        :param builtins.bool essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param builtins.str source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
    ...
    def additional_properties(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ApplicationPassword(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str display_name: A display name for the password. Changing this field forces a new resource to be created.
        :param builtins.str end_date: The end date until which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
        :param builtins.str key_id: (Required) The unique key ID for the generated password.
        :param builtins.str start_date: The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
        :param builtins.str value: (Required) The generated password for the application.
        """
        pulumi.set(__self__, "display_name", display_name)
...
class ApplicationPublicClient(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` or `ms-appx-web` URL.
        """
...
class ApplicationRequiredResourceAccess(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str resource_app_id: The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
...
class ApplicationRequiredResourceAccessResourceAccess(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param builtins.str type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ApplicationSinglePageApplication(dict):
    ...
    def __init__(__self__, *,
                 redirect_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` URL.
        """
        if redirect_uris is not None:
            pulumi.set(__self__, "redirect_uris", redirect_uris)
...
class ApplicationWeb(dict):
    ...
    def __init__(__self__, *,
                 homepage_url: Optional[builtins.str] = None,
                 implicit_grant: Optional['outputs.ApplicationWebImplicitGrant'] = None,
                 logout_url: Optional[builtins.str] = None,
                 redirect_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str homepage_url: Home page or landing page of the application.
        :param 'ApplicationWebImplicitGrantArgs' implicit_grant: An `implicit_grant` block as documented above.
        :param builtins.str logout_url: The URL that will be used by Microsoft's authorization service to sign out a user using front-channel, back-channel or SAML logout protocols.
        :param Sequence[builtins.str] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `http` URL or a URN.
        """
    ...
    def homepage_url(self) -> Optional[builtins.str]:
        """
    ...
    def logout_url(self) -> Optional[builtins.str]:
        """
...
class ApplicationWebImplicitGrant(dict):
    ...
    def __init__(__self__, *,
                 access_token_issuance_enabled: Optional[builtins.bool] = None,
                 id_token_issuance_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow.
        :param builtins.bool id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    def access_token_issuance_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def id_token_issuance_enabled(self) -> Optional[builtins.bool]:
        """
...
class ConditionalAccessPolicyConditions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_app_types: Sequence[builtins.str],
                 ...
                 insider_risk_levels: Optional[builtins.str] = None,
                 ...
                 service_principal_risk_levels: Optional[Sequence[builtins.str]] = None,
                 sign_in_risk_levels: Optional[Sequence[builtins.str]] = None,
                 user_risk_levels: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param Sequence[builtins.str] client_app_types: A list of client application types included in the policy. Possible values are: `all`, `browser`, `mobileAppsAndDesktopClients`, `exchangeActiveSync`, `easSupported` and `other`.
        ...
        :param builtins.str insider_risk_levels: The insider risk level in the policy. Possible values are: `minor`, `moderate`, `elevated`, `unknownFutureValue`.
        ...
        :param Sequence[builtins.str] service_principal_risk_levels: A list of service principal sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `none`, `unknownFutureValue`.
        :param Sequence[builtins.str] sign_in_risk_levels: A list of user sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        :param Sequence[builtins.str] user_risk_levels: A list of user risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def client_app_types(self) -> Sequence[builtins.str]:
        """
    ...
    def insider_risk_levels(self) -> Optional[builtins.str]:
        """
    ...
    def service_principal_risk_levels(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def sign_in_risk_levels(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def user_risk_levels(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsApplications(dict):
    ...
    def __init__(__self__, *,
                 excluded_applications: Optional[Sequence[builtins.str]] = None,
                 included_applications: Optional[Sequence[builtins.str]] = None,
                 included_user_actions: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] excluded_applications: A list of application IDs explicitly excluded from the policy. Can also be set to `Office365`.
        :param Sequence[builtins.str] included_applications: A list of application IDs the policy applies to, unless explicitly excluded (in `excluded_applications`). Can also be set to `All`, `None` or `Office365`. Cannot be specified with `included_user_actions`. One of `included_applications` or `included_user_actions` must be specified.
        :param Sequence[builtins.str] included_user_actions: A list of user actions to include. Supported values are `urn:user:registerdevice` and `urn:user:registersecurityinfo`. Cannot be specified with `included_applications`. One of `included_applications` or `included_user_actions` must be specified.
        """
    ...
    def excluded_applications(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_applications(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_user_actions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsClientApplications(dict):
    ...
    def __init__(__self__, *,
                 excluded_service_principals: Optional[Sequence[builtins.str]] = None,
                 included_service_principals: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] excluded_service_principals: A list of service principal IDs explicitly excluded in the policy.
        :param Sequence[builtins.str] included_service_principals: A list of service principal IDs explicitly included in the policy. Can be set to `ServicePrincipalsInMyTenant` to include all service principals. This is mandatory value when at least one `excluded_service_principals` is set.
        """
    ...
    def excluded_service_principals(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_service_principals(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsDevicesFilter(dict):
    def __init__(__self__, *,
                 ...
                 rule: builtins.str):
        """
        :param builtins.str mode: Whether to include in, or exclude from, matching devices from the policy. Supported values are `include` or `exclude`.
        :param builtins.str rule: Condition filter to match devices. For more information, see [official documentation](https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-condition-filters-for-devices#supported-operators-and-device-properties-for-filters).
        """
...
class ConditionalAccessPolicyConditionsLocations(dict):
    ...
    def __init__(__self__, *,
                 included_locations: Sequence[builtins.str],
                 excluded_locations: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] included_locations: A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        :param Sequence[builtins.str] excluded_locations: A list of location IDs excluded from scope of policy. Can also be set to `AllTrusted`.
        """
    ...
    def included_locations(self) -> Sequence[builtins.str]:
        """
    ...
    def excluded_locations(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsPlatforms(dict):
    ...
    def __init__(__self__, *,
                 included_platforms: Sequence[builtins.str],
                 excluded_platforms: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] included_platforms: A list of platforms the policy applies to, unless explicitly excluded. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        :param Sequence[builtins.str] excluded_platforms: A list of platforms explicitly excluded from the policy. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def included_platforms(self) -> Sequence[builtins.str]:
        """
    ...
    def excluded_platforms(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsUsers(dict):
    ...
    def __init__(__self__, *,
                 excluded_groups: Optional[Sequence[builtins.str]] = None,
                 ...
                 included_groups: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param Sequence[builtins.str] excluded_groups: A list of group IDs excluded from scope of policy.
        ...
        :param Sequence[builtins.str] excluded_roles: A list of role IDs excluded from scope of policy.
        :param Sequence[builtins.str] excluded_users: A list of user IDs excluded from scope of policy and/or `GuestsOrExternalUsers`.
        :param Sequence[builtins.str] included_groups: A list of group IDs in scope of policy unless explicitly excluded.
        ...
        :param Sequence[builtins.str] included_roles: A list of role IDs in scope of policy unless explicitly excluded.
        :param Sequence[builtins.str] included_users: A list of user IDs in scope of policy unless explicitly excluded, or `None` or `All` or `GuestsOrExternalUsers`.
    ...
    def excluded_groups(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_groups(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUser(dict):
    ...
    def __init__(__self__, *,
                 guest_or_external_user_types: Sequence[builtins.str],
        ...
        """
        :param Sequence[builtins.str] guest_or_external_user_types: A list of guest or external user types. Possible values are: `b2bCollaborationGuest`, `b2bCollaborationMember`, `b2bDirectConnectUser`, `internalGuest`, `none`, `otherExternalUser`, `serviceProvider`, `unknownFutureValue`.
    ...
    def guest_or_external_user_types(self) -> Sequence[builtins.str]:
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserExternalTenant(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str membership_kind: The external tenant membership kind. Possible values are: `all`, `enumerated`, `unknownFutureValue`.
        :param Sequence[builtins.str] members: A list tenant IDs. Can only be specified if `membership_kind` is `enumerated`.
        """
...
class ConditionalAccessPolicyGrantControls(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authentication_strength_policy_id: Optional[builtins.str] = None,
                 built_in_controls: Optional[Sequence[builtins.str]] = None,
                 custom_authentication_factors: Optional[Sequence[builtins.str]] = None,
                 terms_of_uses: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str operator: Defines the relationship of the grant controls. Possible values are: `AND`, `OR`.
        :param builtins.str authentication_strength_policy_id: ID of an Authentication Strength Policy to use in this policy. When using a hard-coded ID, the UUID value should be prefixed with: `/policies/authenticationStrengthPolicies/`.
        :param Sequence[builtins.str] built_in_controls: List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        :param Sequence[builtins.str] custom_authentication_factors: List of custom controls IDs required by the policy.
        :param Sequence[builtins.str] terms_of_uses: List of terms of use IDs required by the policy.
    ...
    def authentication_strength_policy_id(self) -> Optional[builtins.str]:
        """
    ...
    def built_in_controls(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def custom_authentication_factors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def terms_of_uses(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConditionalAccessPolicySessionControls(dict):
    ...
    def __init__(__self__, *,
                 application_enforced_restrictions_enabled: Optional[builtins.bool] = None,
                 cloud_app_security_policy: Optional[builtins.str] = None,
                 disable_resilience_defaults: Optional[builtins.bool] = None,
                 persistent_browser_mode: Optional[builtins.str] = None,
                 sign_in_frequency: Optional[builtins.int] = None,
                 sign_in_frequency_authentication_type: Optional[builtins.str] = None,
                 sign_in_frequency_interval: Optional[builtins.str] = None,
                 sign_in_frequency_period: Optional[builtins.str] = None):
        """
        :param builtins.bool application_enforced_restrictions_enabled: Whether application enforced restrictions are enabled. Defaults to `false`.
               
               > Only Office 365, Exchange Online and Sharepoint Online support application enforced restrictions.
        :param builtins.str cloud_app_security_policy: Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        :param builtins.bool disable_resilience_defaults: Disables [resilience defaults](https://learn.microsoft.com/en-us/azure/active-directory/conditional-access/resilience-defaults). Defaults to `false`.
        :param builtins.str persistent_browser_mode: Session control to define whether to persist cookies. Possible values are: `always` or `never`.
        :param builtins.int sign_in_frequency: Number of days or hours to enforce sign-in frequency. Required when `sign_in_frequency_period` is specified.
        :param builtins.str sign_in_frequency_authentication_type: Authentication type for enforcing sign-in frequency. Possible values are: `primaryAndSecondaryAuthentication` or `secondaryAuthentication`. Defaults to `primaryAndSecondaryAuthentication`.
        :param builtins.str sign_in_frequency_interval: The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        :param builtins.str sign_in_frequency_period: The time period to enforce sign-in frequency. Possible values are: `hours` or `days`. Required when `sign_in_frequency_period` is specified.
        """
    ...
    def application_enforced_restrictions_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def cloud_app_security_policy(self) -> Optional[builtins.str]:
        """
    ...
    def disable_resilience_defaults(self) -> Optional[builtins.bool]:
        """
    ...
    def persistent_browser_mode(self) -> Optional[builtins.str]:
        """
    ...
    def sign_in_frequency(self) -> Optional[builtins.int]:
        """
    ...
    def sign_in_frequency_authentication_type(self) -> Optional[builtins.str]:
        """
    ...
    def sign_in_frequency_interval(self) -> Optional[builtins.str]:
        """
    ...
    def sign_in_frequency_period(self) -> Optional[builtins.str]:
        """
...
class CustomDirectoryRolePermission(dict):
    ...
    def __init__(__self__, *,
                 allowed_resource_actions: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] allowed_resource_actions: A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
        pulumi.set(__self__, "allowed_resource_actions", allowed_resource_actions)

    @property
    @pulumi.getter(name="allowedResourceActions")
    def allowed_resource_actions(self) -> Sequence[builtins.str]:
        """
...
class GroupDynamicMembership(dict):
    def __init__(__self__, *,
                 ...
                 rule: builtins.str):
        """
        :param builtins.bool enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param builtins.str rule: The rule that determines membership of this group. For more information, see official documentation on [membership rules syntax](https://docs.microsoft.com/en-gb/azure/active-directory/enterprise-users/groups-dynamic-membership).
...
class GroupRoleManagementPolicyActivationRules(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str required_conditional_access_authentication_context: The Entra ID Conditional Access context that must be present for activation (e.g `c1`). Conflicts with `require_multifactor_authentication`.
        """
...
class GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApprover(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of object acting as an approver. Possible options are `singleUser` and `groupMembers`.
        """
        pulumi.set(__self__, "object_id", object_id)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
@pulumi.output_type
class GroupWithoutMembersDynamicMembership(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 rule: builtins.str):
        """
...
class InvitationMessage(dict):
    ...
    def __init__(__self__, *,
                 additional_recipients: Optional[builtins.str] = None,
                 body: Optional[builtins.str] = None,
                 language: Optional[builtins.str] = None):
        """
        :param builtins.str additional_recipients: Email addresses of additional recipients the invitation message should be sent to. Only 1 additional recipient is currently supported by Azure.
        :param builtins.str body: Customized message body you want to send if you don't want to send the default message. Cannot be specified with `language`.
        :param builtins.str language: The language you want to send the default message in. The value specified must be in ISO 639 format. Defaults to `en-US`. Cannot be specified with `body`.
        """
        if additional_recipients is not None:
            pulumi.set(__self__, "additional_recipients", additional_recipients)
        if body is not None:
    ...
    @property
    @pulumi.getter(name="additionalRecipients")
    def additional_recipients(self) -> Optional[builtins.str]:
        """
...
class NamedLocationCountry(dict):
    ...
    def __init__(__self__, *,
                 countries_and_regions: Sequence[builtins.str],
                 country_lookup_method: Optional[builtins.str] = None,
                 include_unknown_countries_and_regions: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] countries_and_regions: List of countries and/or regions in two-letter format specified by ISO 3166-2.
        :param builtins.str country_lookup_method: Method of detecting country the user is located in. Possible values are `clientIpAddress` for IP-based location and `authenticatorAppGps` for Authenticator app GPS-based location.  Defaults to `clientIpAddress`.
        :param builtins.bool include_unknown_countries_and_regions: Whether IP addresses that don't map to a country or region should be included in the named location. Defaults to `false`.
        """
    ...
    def countries_and_regions(self) -> Sequence[builtins.str]:
        """
    ...
    def country_lookup_method(self) -> Optional[builtins.str]:
        """
    ...
    def include_unknown_countries_and_regions(self) -> Optional[builtins.bool]:
        """
...
class NamedLocationIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] ip_ranges: List of IP address ranges in IPv4 CIDR format (e.g. `1.2.3.4/32`) or any allowable IPv6 format from IETF RFC596. Each CIDR prefix must be `/8` or larger.
        :param builtins.bool trusted: Whether the named location is trusted. Defaults to `false`.
        """
...
class ServicePrincipalAppRole(dict):
    ...
    def __init__(__self__, *,
                 allowed_member_types: Optional[Sequence[builtins.str]] = None,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are: `User` and `Application`, or both.
        :param builtins.str description: A description of the service principal provided for internal end-users.
        :param builtins.str display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param builtins.bool enabled: Specifies whether the permission scope is enabled.
        :param builtins.str id: The unique identifier of the delegated permission.
        :param builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
    ...
    @property
    @pulumi.getter(name="allowedMemberTypes")
    def allowed_member_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ServicePrincipalFeature(dict):
    ...
    def __init__(__self__, *,
                 custom_single_sign_on_app: Optional[builtins.bool] = None,
                 enterprise_application: Optional[builtins.bool] = None,
                 gallery_application: Optional[builtins.bool] = None,
                 visible_to_users: Optional[builtins.bool] = None):
        """
        :param builtins.bool custom_single_sign_on_app: Whether this service principal represents a custom SAML application
        :param builtins.bool enterprise_application: Whether this service principal represents an Enterprise Application
        :param builtins.bool gallery_application: Whether this service principal represents a gallery application
        :param builtins.bool visible_to_users: Whether this app is visible to users in My Apps and Office 365 Launcher
        """
    ...
    def custom_single_sign_on_app(self) -> Optional[builtins.bool]:
        """
    ...
    def enterprise_application(self) -> Optional[builtins.bool]:
        """
    ...
    def gallery_application(self) -> Optional[builtins.bool]:
        """
    ...
    def visible_to_users(self) -> Optional[builtins.bool]:
        """
...
class ServicePrincipalFeatureTag(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hide: Optional[builtins.bool] = None):
        """
        :param builtins.bool custom_single_sign_on: Whether this service principal represents a custom SAML application. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param builtins.bool enterprise: Whether this service principal represents an Enterprise Application. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param builtins.bool gallery: Whether this service principal represents a gallery application. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
...
class ServicePrincipalOauth2PermissionScope(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enabled: Specifies whether the permission scope is enabled.
        :param builtins.str id: The unique identifier of the delegated permission.
        :param builtins.str type: Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves, or whether an administrator should be required for consent to the permissions. Possible values are `User` or `Admin`.
        :param builtins.str user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param builtins.str user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
        :param builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
...
class ServicePrincipalSamlSingleSignOn(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str relay_state: The relative URI the service provider would redirect to after completion of the single sign-on flow.
        """
...
class SynchronizationJobProvisionOnDemandParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str rule_id: The identifier of the synchronization rule to be applied. This rule ID is defined in the schema for a given synchronization job or template.
...
class SynchronizationJobSchedule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expiration: Date and time when this job will expire, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).
        :param builtins.str interval: The interval between synchronization iterations ISO8601. E.g. PT40M run every 40 minutes.
        :param builtins.str state: State of the job.
        """
...
class SynchronizationSecretCredential(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the secret.
...
class GetApplicationApiResult(dict):
    def __init__(__self__, *,
                 known_client_applications: Sequence[builtins.str],
                 mapped_claims_enabled: builtins.bool,
                 oauth2_permission_scopes: Sequence['outputs.GetApplicationApiOauth2PermissionScopeResult'],
                 requested_access_token_version: builtins.int):
        """
        :param Sequence[builtins.str] known_client_applications: A set of application IDs (client IDs), used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        :param builtins.bool mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key.
        ...
        :param builtins.int requested_access_token_version: The access token version expected by this resource. Possible values are `1` or `2`.
        """
        pulumi.set(__self__, "known_client_applications", known_client_applications)
        pulumi.set(__self__, "mapped_claims_enabled", mapped_claims_enabled)
        pulumi.set(__self__, "oauth2_permission_scopes", oauth2_permission_scopes)
    ...
    @property
    @pulumi.getter(name="knownClientApplications")
    def known_client_applications(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="mappedClaimsEnabled")
    def mapped_claims_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="requestedAccessTokenVersion")
    def requested_access_token_version(self) -> builtins.int:
        """
...
class GetApplicationApiOauth2PermissionScopeResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 type: builtins.str,
                 user_consent_description: builtins.str,
                 user_consent_display_name: builtins.str,
                 value: builtins.str):
        """
        :param builtins.str admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        :param builtins.str admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        :param builtins.bool enabled: Determines if the app role is enabled.
        :param builtins.str id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param builtins.str type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        :param builtins.str user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param builtins.str user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
...
class GetApplicationAppRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param Sequence[builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are `User` or `Application`, or both.
        :param builtins.str description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences.
        :param builtins.str display_name: Specifies the display name of the application.
        :param builtins.bool enabled: Determines if the app role is enabled.
        :param builtins.str id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param builtins.str value: The value that is used for the `roles` claim in ID tokens and OAuth 2.0 access tokens that are authenticating an assigned service or user principal.
        """
...
class GetApplicationFeatureTagResult(dict):
    def __init__(__self__, *,
                 ...
                 hide: Optional[builtins.bool] = None):
        """
        :param builtins.bool custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals.
        :param builtins.bool enterprise: Whether this application represents an Enterprise Application for linked service principals.
        :param builtins.bool gallery: Whether this application represents a gallery application for linked service principals.
        :param builtins.bool hide: Whether this app is visible to users in My Apps and Office 365 Launcher.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
        if enterprise is not None:
...
class GetApplicationOptionalClaimAccessTokenResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the optional claim.
        :param Sequence[builtins.str] additional_properties: List of Additional Properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim.
        :param builtins.bool essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param builtins.str source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
        pulumi.set(__self__, "name", name)
...
class GetApplicationPublicClientResult(dict):
    def __init__(__self__, *,
                 redirect_uris: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] redirect_uris: A list of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent.
        """
        pulumi.set(__self__, "redirect_uris", redirect_uris)
...
class GetApplicationRequiredResourceAccessResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str resource_app_id: The unique identifier for the resource that the application requires access to. This is the Application ID of the target application.
        """
        pulumi.set(__self__, "resource_accesses", resource_accesses)
        pulumi.set(__self__, "resource_app_id", resource_app_id)
...
class GetApplicationWebImplicitGrantResult(dict):
    def __init__(__self__, *,
                 access_token_issuance_enabled: builtins.bool,
                 id_token_issuance_enabled: builtins.bool):
        """
        :param builtins.bool access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow.
        :param builtins.bool id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    @property
    @pulumi.getter(name="accessTokenIssuanceEnabled")
    def access_token_issuance_enabled(self) -> builtins.bool:
        """
        Whether this web application can request an access token using OAuth 2.0 implicit flow.
        """
        return pulumi.get(self, "access_token_issuance_enabled")
    ...
    @property
    @pulumi.getter(name="idTokenIssuanceEnabled")
    def id_token_issuance_enabled(self) -> builtins.bool:
        """
        Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
        return pulumi.get(self, "id_token_issuance_enabled")
...
class GetDirectoryRoleTemplatesRoleTemplateResult(dict):
    def __init__(__self__, *,
                 ...
                 object_id: builtins.str):
        """
        :param builtins.str description: The description of the directory role template.
        :param builtins.str display_name: The display name of the directory role template.
        :param builtins.str object_id: The object ID of the directory role template.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "object_id", object_id)
...
class GetDirectoryRolesRoleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: The description of the directory role.
        :param builtins.str display_name: The display name of the directory role.
        :param builtins.str object_id: The object ID of the directory role.
        :param builtins.str template_id: The template ID of the directory role.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "object_id", object_id)
...
class GetDomainsDomainResult(dict):
    def __init__(__self__, *,
                 admin_managed: builtins.bool,
                 authentication_type: builtins.str,
                 default: builtins.bool,
                 domain_name: builtins.str,
                 initial: builtins.bool,
                 root: builtins.bool,
                 supported_services: Sequence[builtins.str],
                 verified: builtins.bool):
        """
        :param builtins.bool admin_managed: Set to `true` to only return domains whose DNS is managed by Microsoft 365. Defaults to `false`.
        :param builtins.str authentication_type: The authentication type of the domain. Possible values include `Managed` or `Federated`.
        :param builtins.bool default: Whether this is the default domain that is used for user creation.
        :param builtins.str domain_name: The name of the domain.
        :param builtins.bool initial: Whether this is the initial domain created by Azure Active Directory.
        :param builtins.bool root: Whether the domain is a verified root domain (not a subdomain).
        :param Sequence[builtins.str] supported_services: A list of capabilities / services supported by the domain. Possible values include `Email`, `Sharepoint`, `EmailInternalRelayOnly`, `OfficeCommunicationsOnline`, `SharePointDefaultDomain`, `FullRedelegation`, `SharePointPublic`, `OrgIdAuthentication`, `Yammer` and `Intune`.
        :param builtins.bool verified: Whether the domain has completed domain ownership verification.
        """
    ...
    def admin_managed(self) -> builtins.bool:
        """
    ...
    def supported_services(self) -> Sequence[builtins.str]:
        """
...
class GetGroupDynamicMembershipResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param builtins.str rule: The rule that determines membership of this group.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "rule", rule)
...
class GetNamedLocationCountryResult(dict):
    def __init__(__self__, *,
                 countries_and_regions: Sequence[builtins.str],
                 country_lookup_method: builtins.str,
                 include_unknown_countries_and_regions: builtins.bool):
        pulumi.set(__self__, "countries_and_regions", countries_and_regions)
        pulumi.set(__self__, "country_lookup_method", country_lookup_method)
        pulumi.set(__self__, "include_unknown_countries_and_regions", include_unknown_countries_and_regions)
    ...
    @property
    @pulumi.getter(name="includeUnknownCountriesAndRegions")
    def include_unknown_countries_and_regions(self) -> builtins.bool:
        return pulumi.get(self, "include_unknown_countries_and_regions")
...
class GetNamedLocationIpResult(dict):
    ...
    @property
    @pulumi.getter
    def trusted(self) -> builtins.bool:
        return pulumi.get(self, "trusted")
...
class GetServicePrincipalAppRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param Sequence[builtins.str] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in daemon service scenarios). Possible values are: `User` and `Application`, or both.
        :param builtins.str description: Permission help text that appears in the admin app assignment and consent experiences.
        :param builtins.str display_name: The display name of the application associated with this service principal.
        :param builtins.bool enabled: Determines if the permission scope is enabled.
        :param builtins.str id: The unique identifier of the delegated permission. Must be a valid UUID.
        :param builtins.str value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
        pulumi.set(__self__, "allowed_member_types", allowed_member_types)
...
class GetServicePrincipalFeatureResult(dict):
    def __init__(__self__, *,
                 custom_single_sign_on_app: builtins.bool,
                 enterprise_application: builtins.bool,
                 gallery_application: builtins.bool,
                 visible_to_users: builtins.bool):
        """
        :param builtins.bool custom_single_sign_on_app: Whether this service principal represents a custom SAML application.
        :param builtins.bool enterprise_application: Whether this service principal represents an Enterprise Application.
        :param builtins.bool gallery_application: Whether this service principal represents a gallery application.
    ...
    @property
    @pulumi.getter(name="customSingleSignOnApp")
    def custom_single_sign_on_app(self) -> builtins.bool:
        """
        Whether this service principal represents a custom SAML application.
        """
        return pulumi.get(self, "custom_single_sign_on_app")
    ...
    @property
    @pulumi.getter(name="enterpriseApplication")
    def enterprise_application(self) -> builtins.bool:
        """
        Whether this service principal represents an Enterprise Application.
        """
        return pulumi.get(self, "enterprise_application")
    ...
    @property
    @pulumi.getter(name="galleryApplication")
    def gallery_application(self) -> builtins.bool:
        """
        Whether this service principal represents a gallery application.
        """
        return pulumi.get(self, "gallery_application")
    ...
    @property
    @pulumi.getter(name="visibleToUsers")
    def visible_to_users(self) -> builtins.bool:
        """
        Whether this app is visible to users in My Apps and Office 365 Launcher.
        """
        return pulumi.get(self, "visible_to_users")
...
class GetServicePrincipalFeatureTagResult(dict):
    def __init__(__self__, *,
                 custom_single_sign_on: builtins.bool,
                 enterprise: builtins.bool,
                 gallery: builtins.bool,
                 hide: builtins.bool):
        """
        :param builtins.bool custom_single_sign_on: Whether this service principal represents a custom SAML application
        :param builtins.bool enterprise: Whether this service principal represents an Enterprise Application
        :param builtins.bool gallery: Whether this service principal represents a gallery application
        :param builtins.bool hide: Whether this app is invisible to users in My Apps and Office 365 Launcher
        """
        pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
        pulumi.set(__self__, "enterprise", enterprise)
        pulumi.set(__self__, "gallery", gallery)
    ...
    @property
    @pulumi.getter(name="customSingleSignOn")
    def custom_single_sign_on(self) -> builtins.bool:
        """
        Whether this service principal represents a custom SAML application
        """
        return pulumi.get(self, "custom_single_sign_on")
    ...
    @property
    @pulumi.getter
    def gallery(self) -> builtins.bool:
        """
        Whether this service principal represents a gallery application
        """
        return pulumi.get(self, "gallery")
...
class GetServicePrincipalsServicePrincipalResult(dict):
    def __init__(__self__, *,
                 account_enabled: builtins.bool,
                 app_role_assignment_required: builtins.bool,
                 application_tenant_id: builtins.str,
                 client_id: builtins.str,
                 display_name: builtins.str,
                 object_id: builtins.str,
                 preferred_single_sign_on_mode: builtins.str,
                 saml_metadata_url: builtins.str,
                 service_principal_names: Sequence[builtins.str],
                 sign_in_audience: builtins.str,
                 tags: Sequence[builtins.str],
                 type: builtins.str):
        """
        :param builtins.bool account_enabled: Whether the service principal account is enabled.
        :param builtins.bool app_role_assignment_required: Whether this service principal requires an app role assignment to a user or group before Azure AD will issue a user or access token to the application.
        :param builtins.str application_tenant_id: The tenant ID where the associated application is registered.
        :param builtins.str client_id: The application ID (client ID) for the associated application
        :param builtins.str display_name: The display name of the application associated with this service principal.
        :param builtins.str object_id: The object ID of the service principal.
        :param builtins.str preferred_single_sign_on_mode: The single sign-on mode configured for this application. Azure AD uses the preferred single sign-on mode to launch the application from Microsoft 365 or the Azure AD My Apps.
        :param builtins.str saml_metadata_url: The URL where the service exposes SAML metadata for federation.
        :param Sequence[builtins.str] service_principal_names: A list of identifier URI(s), copied over from the associated application.
        :param builtins.str sign_in_audience: The Microsoft account types that are supported for the associated application. Possible values include `AzureADMyOrg`, `AzureADMultipleOrgs`, `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount`.
        :param Sequence[builtins.str] tags: A list of tags applied to the service principal.
        :param builtins.str type: Identifies whether the service principal represents an application or a managed identity. Possible values include `Application` or `ManagedIdentity`.
        """
    ...
    def account_enabled(self) -> builtins.bool:
        """
    ...
    def app_role_assignment_required(self) -> builtins.bool:
        """
    ...
    def service_principal_names(self) -> Sequence[builtins.str]:
        """
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
                 ...
                 mail: builtins.str,
                 mail_nickname: builtins.str,
                 object_id: builtins.str,
                 onpremises_immutable_id: builtins.str,
                 onpremises_sam_account_name: builtins.str,
                 onpremises_user_principal_name: builtins.str,
                 usage_location: builtins.str,
                 user_principal_name: builtins.str):
        """
        :param builtins.bool account_enabled: Whether the account is enabled.
        :param builtins.str display_name: The display name of the user.
        :param builtins.str employee_id: The employee identifier assigned to the user by the organisation.
        :param builtins.str mail: The SMTP email address of the user.
        :param builtins.str mail_nickname: The email alias of the user.
        :param builtins.str object_id: The object ID of the user.
        :param builtins.str onpremises_immutable_id: The value used to associate an on-premises Active Directory user account with their Azure AD user object.
        :param builtins.str onpremises_sam_account_name: The on-premise SAM account name of the user.
        :param builtins.str onpremises_user_principal_name: The on-premise user principal name of the user.
        :param builtins.str usage_location: The usage location of the user.
        :param builtins.str user_principal_name: The user principal name (UPN) of the user.
        """
        pulumi.set(__self__, "account_enabled", account_enabled)
        pulumi.set(__self__, "display_name", display_name)
