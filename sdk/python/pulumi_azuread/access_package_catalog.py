...
class AccessPackageCatalogArgs:
    def __init__(__self__, *,
                 ...
                 externally_visible: Optional[pulumi.Input[builtins.bool]] = None,
                 published: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a AccessPackageCatalog resource.
        :param pulumi.Input[builtins.str] description: The description of the access package catalog.
        :param pulumi.Input[builtins.str] display_name: The display name of the access package catalog.
        :param pulumi.Input[builtins.bool] externally_visible: Whether the access packages in this catalog can be requested by users outside the tenant.
        :param pulumi.Input[builtins.bool] published: Whether the access packages in this catalog are available for management.
        """
    ...
    def externally_visible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def externally_visible(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AccessPackageCatalog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            externally_visible: Optional[pulumi.Input[builtins.bool]] = None,
            published: Optional[pulumi.Input[builtins.bool]] = None) -> 'AccessPackageCatalog':
        """
    ...
    @property
    @pulumi.getter(name="externallyVisible")
    def externally_visible(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the access packages in this catalog can be requested by users outside the tenant.
        """
        return pulumi.get(self, "externally_visible")
