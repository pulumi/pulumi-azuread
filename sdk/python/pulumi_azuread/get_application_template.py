...
class GetApplicationTemplateResult:
    ...
    def supported_provisioning_types(self) -> Sequence[builtins.str]:
        """
    ...
    def supported_single_sign_on_modes(self) -> Sequence[builtins.str]:
        """
...
def get_application_template(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: Specifies the display name of the templated application.
    :param builtins.str template_id: Specifies the ID of the templated application.
...
def get_application_template_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
