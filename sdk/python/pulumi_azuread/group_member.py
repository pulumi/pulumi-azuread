...
class GroupMemberArgs:
    def __init__(__self__, *,
                 group_object_id: pulumi.Input[builtins.str],
                 member_object_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a GroupMember resource.
        :param pulumi.Input[builtins.str] group_object_id: The object ID of the group you want to add the member to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] member_object_id: The object ID of the principal you want to add as a member to the group. Supported object types are Users, Groups or Service Principals. Changing this forces a new resource to be created.
        """
    ...
    def group_object_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_object_id(self, value: pulumi.Input[builtins.str]):
...
class _GroupMemberState:
    def __init__(__self__, *,
                 group_object_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="groupObjectId")
    def group_object_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The object ID of the group you want to add the member to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "group_object_id")
    ...
    @group_object_id.setter
    def group_object_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_object_id", value)
...
class GroupMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            group_object_id: Optional[pulumi.Input[builtins.str]] = None,
            member_object_id: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupMember':
        """
    ...
    @property
    @pulumi.getter(name="groupObjectId")
    def group_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the group you want to add the member to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "group_object_id")
