...
def get_administrative_unit(display_name: Optional[builtins.str] = None,
    ...
    *Look up by object ID*
    ...
    :param builtins.str display_name: Specifies the display name of the administrative unit.
    :param builtins.str object_id: Specifies the object ID of the administrative unit.
...
def get_administrative_unit_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
