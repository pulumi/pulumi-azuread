...
class GetGroupResult:
    ...
    def assignable_to_role(self) -> builtins.bool:
        """
    ...
    def auto_subscribe_new_members(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def behaviors(self) -> Sequence[builtins.str]:
        """
    ...
    def external_senders_allowed(self) -> builtins.bool:
        """
    ...
    def hide_from_address_lists(self) -> builtins.bool:
        """
    ...
    def hide_from_outlook_clients(self) -> builtins.bool:
        """
    ...
    def include_transitive_members(self) -> Optional[builtins.bool]:
    ...
    def onpremises_sync_enabled(self) -> builtins.bool:
        """
    ...
    def provisioning_options(self) -> Sequence[builtins.str]:
        """
    ...
    def proxy_addresses(self) -> Sequence[builtins.str]:
        """
    ...
    def writeback_enabled(self) -> builtins.bool:
        """
...
def get_group(display_name: Optional[builtins.str] = None,
              include_transitive_members: Optional[builtins.bool] = None,
              mail_enabled: Optional[builtins.bool] = None,
              mail_nickname: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: The display name for the group.
    :param builtins.bool include_transitive_members: Whether to include transitive members (a flat list of all nested members). Defaults to `false`.
    :param builtins.bool mail_enabled: Whether the group is mail-enabled.
    :param builtins.str mail_nickname: The mail alias for the group, unique in the organisation.
    :param builtins.str object_id: Specifies the object ID of the group.
    :param builtins.bool security_enabled: Whether the group is a security group.
...
def get_group_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     include_transitive_members: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     mail_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     mail_nickname: Optional[pulumi.Input[Optional[builtins.str]]] = None,
