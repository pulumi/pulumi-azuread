...
class DirectoryRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] app_scope_object_id: Identifier of the app-specific scope when the assignment scope is app-specific. Cannot be used with `directory_scope_object_id`. Changing this forces a new resource to be created.
        :param pulumi.Input[str] directory_scope_object_id: The object ID of a directory object representing the scope of the assignment. Cannot be used with `app_scope_object_id`. Changing this forces a new resource to be created.
...
class DirectoryRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        *Assignment for a built-in role*
        ...
        example_directory_role_assignment = azuread.DirectoryRoleAssignment("exampleDirectoryRoleAssignment",
        ...
        *Assignment for a custom role*
        ...
        example_user = azuread.get_user(user_principal_name="jdoe@hashicorp.com")
        example_custom_directory_role = azuread.CustomDirectoryRole("exampleCustomDirectoryRole",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DirectoryRoleAssignmentArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a single directory role assignment within Azure Active Directory.
    ...
    @property
    @pulumi.getter(name="appScopeObjectId")
    def app_scope_object_id(self) -> pulumi.Output[Optional[str]]:
        """
        Identifier of the app-specific scope when the assignment scope is app-specific. Cannot be used with `directory_scope_object_id`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_scope_object_id")
    ...
    @property
    @pulumi.getter(name="directoryScopeObjectId")
    def directory_scope_object_id(self) -> pulumi.Output[Optional[str]]:
        """
        The object ID of a directory object representing the scope of the assignment. Cannot be used with `app_scope_object_id`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "directory_scope_object_id")
