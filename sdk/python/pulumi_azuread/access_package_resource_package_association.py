...
class AccessPackageResourcePackageAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_access_package = azuread.index.access_package.AccessPackage("example",
            ...
            catalog_id=example_catalog.id)
        example_access_package_resource_package_association = azuread.index.access_package_resource_package_association.AccessPackageResourcePackageAssociation("example",
