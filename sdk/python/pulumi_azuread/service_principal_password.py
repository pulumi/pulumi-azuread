...
class ServicePrincipalPasswordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for which this password should be created. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] display_name: A display name for the password.
...
class _ServicePrincipalPasswordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for which this password should be created. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] start_date: The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] value: The password for this service principal, which is generated by Azure Active Directory.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if end_date is not None:
...
class ServicePrincipalPassword(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None,
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ServicePrincipalPassword':
        """
