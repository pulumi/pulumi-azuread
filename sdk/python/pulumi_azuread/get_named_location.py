...
def get_named_location(display_name: Optional[builtins.str] = None,
    ...
    * `trusted` - Whether the named location is trusted.
    ...
    :param builtins.str display_name: Specifies the display named of the named location to look up.
    """
    __args__ = dict()
...
def get_named_location_output(display_name: Optional[pulumi.Input[builtins.str]] = None,
