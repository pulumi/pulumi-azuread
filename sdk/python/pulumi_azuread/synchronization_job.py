...
class SynchronizationJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for which this synchronization job should be created. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] template_id: Identifier of the synchronization template this job is based on.
        :param pulumi.Input[builtins.bool] enabled: Whether the provisioning job is enabled. Default state is `true`.
        """
...
class SynchronizationJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None,
            template_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SynchronizationJob':
        """
