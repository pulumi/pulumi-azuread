...
class SynchronizationJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service_principal_id: The object ID of the service principal for which this synchronization job should be created
        :param pulumi.Input[str] template_id: Identifier of the synchronization template this job is based on.
        :param pulumi.Input[bool] enabled: Whether or not the synchronization job is enabled
        """
...
class SynchronizationJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SynchronizationJob resource with the given unique name, props, and options.
