...
class AccessPackageAssignmentPolicyArgs:
    def __init__(__self__, *,
                 ...
                 extension_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] access_package_id: The ID of the access package that will contain the policy.
        :param pulumi.Input[builtins.str] description: The description of the policy.
        :param pulumi.Input[builtins.str] display_name: The display name of the policy.
        ...
        :param pulumi.Input[builtins.int] duration_in_days: How many days this assignment is valid for.
        :param pulumi.Input[builtins.str] expiration_date: The date that this assignment expires, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z).
        :param pulumi.Input[builtins.bool] extension_enabled: Whether users will be able to request extension of their access to this package before their access expires.
    ...
    def extension_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def extension_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AccessPackageAssignmentPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="durationInDays")
    def duration_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        How many days this assignment is valid for.
        """
        return pulumi.get(self, "duration_in_days")
    ...
    @property
    @pulumi.getter(name="extensionEnabled")
    def extension_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether users will be able to request extension of their access to this package before their access expires.
        """
        return pulumi.get(self, "extension_enabled")
