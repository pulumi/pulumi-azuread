...
class SynchronizationSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for which this synchronization secrets should be stored. Changing this field forces a new resource to be created.
...
class SynchronizationSecret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            credentials: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SynchronizationSecretCredentialArgs', 'SynchronizationSecretCredentialArgsDict']]]]] = None,
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SynchronizationSecret':
        """
