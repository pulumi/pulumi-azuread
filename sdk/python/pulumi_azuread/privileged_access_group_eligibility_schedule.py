...
class PrivilegedAccessGroupEligibilityScheduleArgs:
    def __init__(__self__, *,
                 ...
                 permanent_assignment: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] assignment_type: The type of assignment to the group. Can be either `member` or `owner`.
        :param pulumi.Input[builtins.str] group_id: The Object ID of the Azure AD group to which the principal will be assigned.
        :param pulumi.Input[builtins.str] principal_id: The Object ID of the principal to be assigned to the above group. Can be either a user or a group.
        :param pulumi.Input[builtins.str] duration: The duration that this assignment is valid for, formatted as an ISO8601 duration (e.g. P30D for 30 days, PT3H for three hours).
        :param pulumi.Input[builtins.str] expiration_date: The date that this assignment expires, formatted as an RFC3339 date string (e.g. 2018-01-01T01:02:03Z).
        :param pulumi.Input[builtins.str] justification: The justification for this assignment. May be required by the role policy.
        :param pulumi.Input[builtins.bool] permanent_assignment: Is this assigment permanently valid.
        ...
        :param pulumi.Input[builtins.str] start_date: The date from which this assignment is valid, formatted as an RFC3339 date string (e.g. 2018-01-01T01:02:03Z). If not provided, the assignment is immediately valid.
        :param pulumi.Input[builtins.str] ticket_number: The ticket number in the ticket system approving this assignment. May be required by the role policy.
        :param pulumi.Input[builtins.str] ticket_system: The ticket system containing the ticket number approving this assignment. May be required by the role policy.
        """
    ...
    def permanent_assignment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def permanent_assignment(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PrivilegedAccessGroupEligibilityScheduleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] principal_id: The Object ID of the principal to be assigned to the above group. Can be either a user or a group.
        :param pulumi.Input[builtins.str] start_date: The date from which this assignment is valid, formatted as an RFC3339 date string (e.g. 2018-01-01T01:02:03Z). If not provided, the assignment is immediately valid.
        :param pulumi.Input[builtins.str] status: (String) The provisioning status of this request.
        :param pulumi.Input[builtins.str] ticket_number: The ticket number in the ticket system approving this assignment. May be required by the role policy.
        :param pulumi.Input[builtins.str] ticket_system: The ticket system containing the ticket number approving this assignment. May be required by the role policy.
        """
...
class PrivilegedAccessGroupEligibilitySchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            ticket_number: Optional[pulumi.Input[builtins.str]] = None,
            ticket_system: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivilegedAccessGroupEligibilitySchedule':
        """
    ...
    @property
    @pulumi.getter(name="permanentAssignment")
    def permanent_assignment(self) -> pulumi.Output[builtins.bool]:
        """
        Is this assigment permanently valid.
    ...
    @property
    @pulumi.getter(name="ticketNumber")
    def ticket_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ticket number in the ticket system approving this assignment. May be required by the role policy.
        """
        return pulumi.get(self, "ticket_number")
    ...
    @property
    @pulumi.getter(name="ticketSystem")
    def ticket_system(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ticket system containing the ticket number approving this assignment. May be required by the role policy.
        """
        return pulumi.get(self, "ticket_system")
