...
class GetGroupsResult:
    ...
    def display_names(self) -> Sequence[builtins.str]:
        """
    ...
    def ignore_missing(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "ignore_missing")

    @property
    @pulumi.getter(name="mailEnabled")
    def mail_enabled(self) -> builtins.bool:
    ...
    def return_all(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "return_all")

    @property
    @pulumi.getter(name="securityEnabled")
    def security_enabled(self) -> builtins.bool:
...
def get_groups(display_name_prefix: Optional[builtins.str] = None,
               display_names: Optional[Sequence[builtins.str]] = None,
               ignore_missing: Optional[builtins.bool] = None,
               mail_enabled: Optional[builtins.bool] = None,
               object_ids: Optional[Sequence[builtins.str]] = None,
               return_all: Optional[builtins.bool] = None,
               security_enabled: Optional[builtins.bool] = None,
    ...
    *Look up all security-enabled groups that are not mail-enabled*
    ...
    :param builtins.str display_name_prefix: A common display name prefix to match when returning groups.
    :param Sequence[builtins.str] display_names: The display names of the groups.
    :param builtins.bool ignore_missing: Ignore missing groups and return groups that were found. The data source will still fail if no groups are found. Cannot be specified with `return_all`. Defaults to `false`.
    :param builtins.bool mail_enabled: Whether the returned groups should be mail-enabled. By itself this does not exclude security-enabled groups. Setting this to `true` ensures all groups are mail-enabled, and setting to `false` ensures that all groups are _not_ mail-enabled. To ignore this filter, omit the property or set it to null. Cannot be specified together with `object_ids`.
    :param Sequence[builtins.str] object_ids: The object IDs of the groups.
    :param builtins.bool return_all: A flag to denote if all groups should be fetched and returned. Cannot be specified wth `ignore_missing`. Defaults to `false`.
    :param builtins.bool security_enabled: Whether the returned groups should be security-enabled. By itself this does not exclude mail-enabled groups. Setting this to `true` ensures all groups are security-enabled, and setting to `false` ensures that all groups are _not_ security-enabled. To ignore this filter, omit the property or set it to null. Cannot be specified together with `object_ids`.
...
def get_groups_output(display_name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      display_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      ignore_missing: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      mail_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      object_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      return_all: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      security_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
