...
class GetApplicationResult:
    ...
    def app_role_ids(self) -> Mapping[str, builtins.str]:
        """
    ...
    def device_only_auth_enabled(self) -> builtins.bool:
        """
    ...
    def fallback_public_client_enabled(self) -> builtins.bool:
        """
    ...
    def group_membership_claims(self) -> Sequence[builtins.str]:
        """
    ...
    def identifier_uris(self) -> Sequence[builtins.str]:
        """
    ...
    def oauth2_permission_scope_ids(self) -> Mapping[str, builtins.str]:
        """
    ...
    def oauth2_post_response_required(self) -> builtins.bool:
        """
...
def get_application(client_id: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: Specifies the Client ID of the application.
    :param builtins.str display_name: Specifies the display name of the application.
    :param builtins.str identifier_uri: Specifies any identifier URI of the application. See also the `identifier_uris` attribute which contains a list of all identifier URIs for the application.
           
           > One of `client_id`, `display_name`, `object_id`, or `identifier_uri` must be specified.
    :param builtins.str object_id: Specifies the Object ID of the application.
    """
    __args__ = dict()
...
def get_application_output(client_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           identifier_uri: Optional[pulumi.Input[Optional[builtins.str]]] = None,
