...
def get_directory_object(object_id: Optional[builtins.str] = None,
    ...
    * `type` - The shortened OData type of the directory object. Possible values include: `Group`, `User` or `ServicePrincipal`.
    ...
    :param builtins.str object_id: Specifies the Object ID of the directory object to look up.
    """
    __args__ = dict()
...
def get_directory_object_output(object_id: Optional[pulumi.Input[builtins.str]] = None,
