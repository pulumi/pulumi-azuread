...
class ApplicationFallbackPublicClientArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether to enable the application as a fallback public client.
...
class ApplicationFallbackPublicClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            application_id: Optional[pulumi.Input[builtins.str]] = None,
            enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'ApplicationFallbackPublicClient':
        """
