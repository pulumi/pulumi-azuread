...
class ApplicationIdentifierUriArgs:
    def __init__(__self__, *,
                 ...
                 identifier_uri: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] identifier_uri: The user-defined URI that uniquely identifies an application within its Azure AD tenant, or within a verified custom domain if the application is multi-tenant. Changing this forces a new resource to be created.
        """
    ...
    def identifier_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def identifier_uri(self, value: pulumi.Input[builtins.str]):
...
class ApplicationIdentifierUri(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            application_id: Optional[pulumi.Input[builtins.str]] = None,
            identifier_uri: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationIdentifierUri':
        """
    ...
    @property
    @pulumi.getter(name="identifierUri")
    def identifier_uri(self) -> pulumi.Output[builtins.str]:
        """
        The user-defined URI that uniquely identifies an application within its Azure AD tenant, or within a verified custom domain if the application is multi-tenant. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "identifier_uri")
