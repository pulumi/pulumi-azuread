...
def get_service_principals(client_ids: Optional[Sequence[builtins.str]] = None,
    ...
    *Look up by service principal object IDs*
    ...
    :param Sequence[builtins.str] client_ids: A list of client IDs of the applications associated with the service principals.
    :param Sequence[builtins.str] display_names: A list of display names of the applications associated with the service principals.
    :param builtins.bool ignore_missing: Ignore missing service principals and return all service principals that are found. The data source will still fail if no service principals are found. Defaults to false.
    :param Sequence[builtins.str] object_ids: The object IDs of the service principals.
    :param builtins.bool return_all: When `true`, the data source will return all service principals. Cannot be used with `ignore_missing`. Defaults to false.
...
def get_service_principals_output(client_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
