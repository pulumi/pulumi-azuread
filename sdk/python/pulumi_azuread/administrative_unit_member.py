...
class AdministrativeUnitMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] member_object_id: The object ID of the user or group you want to add as a member of the administrative unit. Changing this forces a new resource to be created.
...
class AdministrativeUnitMember(pulumi.CustomResource):
    ...
    pulumi_type = "azuread:index/administrativeUnitMember:AdministrativeUnitMember"
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            administrative_unit_object_id: Optional[pulumi.Input[builtins.str]] = None,
            member_object_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AdministrativeUnitMember':
        """
    ...
    @property
    @pulumi.getter(name="administrativeUnitObjectId")
    def administrative_unit_object_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The object ID of the administrative unit you want to add the member to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "administrative_unit_object_id")
