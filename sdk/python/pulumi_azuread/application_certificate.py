...
class ApplicationCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The resource ID of the application for which this certificate should be created. Changing this field forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] end_date: The end date until which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If omitted, the API will decide a suitable expiry date, which is typically around 2 years from the start date. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] end_date_relative: A relative duration for which the certificate is valid until, for example `240h` (10 days) or `2400h30m`. Changing this field forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] key_id: A UUID used to uniquely identify this certificate. If omitted, a random UUID will be automatically generated. Changing this field forces a new resource to be created.
...
class ApplicationCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationCertificate':
        """
