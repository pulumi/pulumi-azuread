...
class ServicePrincipalTokenSigningCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Specifies a friendly name for the certificate. Must start with `CN=`. Changing this field forces a new resource to be created.
               
               > If not specified, it will default to `CN=Microsoft Azure Federated SSO Certificate`.
        :param pulumi.Input[builtins.str] end_date: The end date until which the token signing certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
        """
...
class _ServicePrincipalTokenSigningCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Specifies a friendly name for the certificate. Must start with `CN=`. Changing this field forces a new resource to be created.
               ...
               > If not specified, it will default to `CN=Microsoft Azure Federated SSO Certificate`.
        :param pulumi.Input[builtins.str] end_date: The end date until which the token signing certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] key_id: A UUID used to uniquely identify the verify certificate.
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for which this certificate should be created. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] start_date: The start date from which the certificate is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).
        :param pulumi.Input[builtins.str] thumbprint: A SHA-1 generated thumbprint of the token signing certificate, which can be used to set the preferred signing certificate for a service principal.
        :param pulumi.Input[builtins.str] value: The certificate data, which is PEM encoded but does not include the header `-----BEGIN CERTIFICATE-----\\n` or the footer `\\n-----END CERTIFICATE-----`.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if end_date is not None:
...
class ServicePrincipalTokenSigningCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ServicePrincipalTokenSigningCertificate':
        """
