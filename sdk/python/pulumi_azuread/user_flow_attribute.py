...
class UserFlowAttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_type: The data type of the user flow attribute. Possible values are `boolean`, `dateTime`, `int64`, `string` or `stringCollection`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: The description of the user flow attribute that is shown to the user at the time of sign-up.
        :param pulumi.Input[builtins.str] display_name: The display name of the user flow attribute. Changing this forces a new resource to be created.
        """
...
class _UserFlowAttributeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attribute_type: The type of the user flow attribute. Values include `builtIn`, `custom` or `required`.
        :param pulumi.Input[builtins.str] data_type: The data type of the user flow attribute. Possible values are `boolean`, `dateTime`, `int64`, `string` or `stringCollection`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: The description of the user flow attribute that is shown to the user at the time of sign-up.
        :param pulumi.Input[builtins.str] display_name: The display name of the user flow attribute. Changing this forces a new resource to be created.
        """
...
class UserFlowAttribute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            data_type: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            display_name: Optional[pulumi.Input[builtins.str]] = None) -> 'UserFlowAttribute':
        """
