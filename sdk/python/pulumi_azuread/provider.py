...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_certificate_password: The password to decrypt the Client Certificate. For use when authenticating as a Service Principal using a Client
               Certificate
        ...
        :param pulumi.Input[builtins.str] client_id: The Client ID which should be used for service principal authentication
        :param pulumi.Input[builtins.str] client_id_file_path: The path to a file containing the Client ID which should be used for service principal authentication
        :param pulumi.Input[builtins.str] client_secret: The application password to use when authenticating as a Service Principal using a Client Secret
        :param pulumi.Input[builtins.str] client_secret_file_path: The path to a file containing the application password to use when authenticating as a Service Principal using a Client
               Secret
        :param pulumi.Input[builtins.str] environment: The cloud environment which should be used. Possible values are: `global` (also `public`), `usgovernmentl4` (also
        ...
        :param pulumi.Input[builtins.str] msi_endpoint: The path to a custom endpoint for Managed Identity - in most circumstances this should be detected automatically
        ...
        :param pulumi.Input[builtins.str] oidc_token: The ID token for use when authenticating as a Service Principal using OpenID Connect.
        :param pulumi.Input[builtins.str] oidc_token_file_path: The path to a file containing an ID token for use when authenticating as a Service Principal using OpenID Connect.
        ...
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID which should be used. Works with all authentication methods except Managed Identity
        ...
        :param pulumi.Input[builtins.bool] use_msi: Allow Managed Identity to be used for Authentication
