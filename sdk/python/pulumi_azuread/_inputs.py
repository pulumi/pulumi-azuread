...
if not MYPY:
    class AccessPackageAssignmentPolicyApprovalSettingsArgsDict(TypedDict):
        ...
        """
        approval_required_for_extension: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        requestor_justification_required: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsArgs:
    def __init__(__self__, *,
                 ...
                 approval_required_for_extension: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 requestor_justification_required: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] approval_required: Whether an approval is required.
        :param pulumi.Input[builtins.bool] approval_required_for_extension: Whether an approval is required to grant extension. Same approval settings used to approve initial access will apply.
        ...
        :param pulumi.Input[builtins.bool] requestor_justification_required: Whether a requestor is required to provide a justification to request an access package. Justification is visible to approvers and the requestor.
        """
    ...
    def approval_required_for_extension(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether an approval is required to grant extension. Same approval settings used to approve initial access will apply.
        """
    ...
    def approval_required_for_extension(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def requestor_justification_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether a requestor is required to provide a justification to request an access package. Justification is visible to approvers and the requestor.
        """
    ...
    def requestor_justification_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageArgsDict(TypedDict):
        approval_timeout_in_days: pulumi.Input[builtins.int]
        """
        ...
        """
        alternative_approval_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        approver_justification_required: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        enable_alternative_approval_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageArgs:
    def __init__(__self__, *,
                 approval_timeout_in_days: pulumi.Input[builtins.int],
                 alternative_approval_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 approver_justification_required: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_alternative_approval_in_days: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] approval_timeout_in_days: Decision must be made in how many days? If a request is not approved within this time period after it is made, it will be automatically rejected
        :param pulumi.Input[builtins.bool] alternative_approval_enabled: If no action taken, forward to alternate approvers?
        ...
        :param pulumi.Input[builtins.bool] approver_justification_required: Whether an approver must provide a justification for their decision. Justification is visible to other approvers and the requestor
        :param pulumi.Input[builtins.int] enable_alternative_approval_in_days: Forward to alternate approver(s) after how many days?
    ...
    def approval_timeout_in_days(self) -> pulumi.Input[builtins.int]:
        """
        Decision must be made in how many days? If a request is not approved within this time period after it is made, it will be automatically rejected
        """
    ...
    def approval_timeout_in_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "approval_timeout_in_days", value)

    @property
    @pulumi.getter(name="alternativeApprovalEnabled")
    def alternative_approval_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If no action taken, forward to alternate approvers?
        """
    ...
    def alternative_approval_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def approver_justification_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether an approver must provide a justification for their decision. Justification is visible to other approvers and the requestor
        """
    ...
    def approver_justification_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "approver_justification_required", value)

    @property
    @pulumi.getter(name="enableAlternativeApprovalInDays")
    def enable_alternative_approval_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Forward to alternate approver(s) after how many days?
        """
    ...
    def enable_alternative_approval_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApproverArgsDict(TypedDict):
        subject_type: pulumi.Input[builtins.str]
        """
        Type of users
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApproverArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subject_type: Type of users
        :param pulumi.Input[builtins.bool] backup: For a user in an approval stage, this property indicates whether the user is a backup fallback approver
        :param pulumi.Input[builtins.str] object_id: The object ID of the subject
        """
    ...
    def subject_type(self) -> pulumi.Input[builtins.str]:
        """
        Type of users
        """
    ...
    @subject_type.setter
    def subject_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AccessPackageAssignmentPolicyAssignmentReviewSettingsArgsDict(TypedDict):
        access_recommendation_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        access_review_timeout_behavior: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        review_frequency: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        review_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        starting_on: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AccessPackageAssignmentPolicyAssignmentReviewSettingsArgs:
    def __init__(__self__, *,
                 access_recommendation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 access_review_timeout_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 approver_justification_required: Optional[pulumi.Input[builtins.bool]] = None,
                 duration_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 review_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 review_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 starting_on: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] access_recommendation_enabled: Whether to show the reviewer decision helpers. If enabled, system recommendations based on users' access information will be shown to the reviewers. The reviewer will be recommended to approve the review if the user has signed-in at least once during the last 30 days. The reviewer will be recommended to deny the review if the user has not signed-in during the last 30 days.
        :param pulumi.Input[builtins.str] access_review_timeout_behavior: Specifies the actions the system takes if reviewers don't respond in time. Valid values are `keepAccess`, `removeAccess`, or `acceptAccessRecommendation`.
        :param pulumi.Input[builtins.bool] approver_justification_required: Whether a reviewer needs to provide a justification for their decision. Justification is visible to other reviewers and the requestor.
        :param pulumi.Input[builtins.int] duration_in_days: How many days each occurrence of the access review series will run.
        :param pulumi.Input[builtins.bool] enabled: Whether to enable assignment review.
        :param pulumi.Input[builtins.str] review_frequency: This will determine how often the access review campaign runs, valid values are `weekly`, `monthly`, `quarterly`, `halfyearly`, or `annual`.
        :param pulumi.Input[builtins.str] review_type: Self-review or specific reviewers. Valid values are `Manager`, `Reviewers`, or `Self`.
        ...
        :param pulumi.Input[builtins.str] starting_on: This is the date the access review campaign will start on, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z), default is now. Once an access review has been created, you cannot update its start date
        """
    ...
    def access_recommendation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to show the reviewer decision helpers. If enabled, system recommendations based on users' access information will be shown to the reviewers. The reviewer will be recommended to approve the review if the user has signed-in at least once during the last 30 days. The reviewer will be recommended to deny the review if the user has not signed-in during the last 30 days.
        """
    ...
    def access_recommendation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "access_recommendation_enabled", value)

    @property
    @pulumi.getter(name="accessReviewTimeoutBehavior")
    def access_review_timeout_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the actions the system takes if reviewers don't respond in time. Valid values are `keepAccess`, `removeAccess`, or `acceptAccessRecommendation`.
        """
    ...
    def access_review_timeout_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def review_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This will determine how often the access review campaign runs, valid values are `weekly`, `monthly`, `quarterly`, `halfyearly`, or `annual`.
        """
    ...
    def review_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "review_frequency", value)

    @property
    @pulumi.getter(name="reviewType")
    def review_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Self-review or specific reviewers. Valid values are `Manager`, `Reviewers`, or `Self`.
        """
    ...
    @review_type.setter
    def review_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def starting_on(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This is the date the access review campaign will start on, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z), default is now. Once an access review has been created, you cannot update its start date
        """
    ...
    @starting_on.setter
    def starting_on(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AccessPackageAssignmentPolicyQuestionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] required: Whether this question is required.
        :param pulumi.Input[builtins.int] sequence: The sequence number of this question.
        """
...
if not MYPY:
    class AccessPackageAssignmentPolicyQuestionChoiceArgsDict(TypedDict):
        actual_value: pulumi.Input[builtins.str]
        """
...
class AccessPackageAssignmentPolicyQuestionChoiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] actual_value: The actual value of this choice
    ...
    def actual_value(self) -> pulumi.Input[builtins.str]:
        """
        The actual value of this choice
        """
    ...
    @actual_value.setter
    def actual_value(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueArgsDict(TypedDict):
        default_text: pulumi.Input[builtins.str]
        """
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_text: The default text of this question
    ...
    def default_text(self) -> pulumi.Input[builtins.str]:
        """
        The default text of this question
        """
    ...
    @default_text.setter
    def default_text(self, value: pulumi.Input[builtins.str]):
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueLocalizedTextArgs:
    def __init__(__self__, *,
                 ...
                 language_code: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The localized content of this question
        :param pulumi.Input[builtins.str] language_code: The language code of this question content
        """
...
if not MYPY:
    class AccessPackageAssignmentPolicyRequestorSettingsArgsDict(TypedDict):
        ...
        """
        requests_accepted: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to accept requests using this policy. When `false`, no new requests can be made using this policy.
        """
        scope_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AccessPackageAssignmentPolicyRequestorSettingsArgs:
    def __init__(__self__, *,
                 ...
                 requests_accepted: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def requests_accepted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to accept requests using this policy. When `false`, no new requests can be made using this policy.
        """
    ...
    def requests_accepted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ApplicationApiArgsDict(TypedDict):
        known_client_applications: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        mapped_claims_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        requested_access_token_version: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ApplicationApiArgs:
    def __init__(__self__, *,
                 known_client_applications: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 mapped_claims_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] known_client_applications: A set of client IDs, used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        :param pulumi.Input[builtins.bool] mapped_claims_enabled: Allows an application to use claims mapping without specifying a custom signing key. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.int] requested_access_token_version: The access token version expected by this resource. Must be one of `1` or `2`, and must be `2` when `sign_in_audience` is either `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount` Defaults to `1`.
        """
    ...
    def known_client_applications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A set of client IDs, used for bundling consent if you have a solution that contains two parts: a client app and a custom web API app.
        """
    ...
    def known_client_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "known_client_applications", value)

    @property
    @pulumi.getter(name="mappedClaimsEnabled")
    def mapped_claims_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allows an application to use claims mapping without specifying a custom signing key. Defaults to `false`.
        """
    ...
    def mapped_claims_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ApplicationApiOauth2PermissionScopeArgsDict(TypedDict):
        ...
        """
        admin_consent_description: NotRequired[pulumi.Input[builtins.str]]
        """
        Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        """
        admin_consent_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_consent_description: NotRequired[pulumi.Input[builtins.str]]
        """
        Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        """
        user_consent_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationApiOauth2PermissionScopeArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str],
                 admin_consent_description: Optional[pulumi.Input[builtins.str]] = None,
                 admin_consent_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_consent_description: Optional[pulumi.Input[builtins.str]] = None,
                 user_consent_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: The unique identifier of the delegated permission. Must be a valid UUID.
               
               > **Tip: Generating a UUID for the `id` field** To generate a value for the `id` field in cases where the actual UUID is not important, you can use the `random_uuid` resource. See the application example in the provider repository.
        :param pulumi.Input[builtins.str] admin_consent_description: Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        :param pulumi.Input[builtins.str] admin_consent_display_name: Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        :param pulumi.Input[builtins.bool] enabled: Determines if the permission scope is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] type: Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves, or whether an administrator should be required for consent to the permissions. Defaults to `User`. Possible values are `User` or `Admin`.
        :param pulumi.Input[builtins.str] user_consent_description: Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        :param pulumi.Input[builtins.str] user_consent_display_name: Display name for the delegated permission that appears in the end user consent experience.
        :param pulumi.Input[builtins.str] value: The value that is used for the `scp` claim in OAuth 2.0 access tokens
        """
    ...
    def admin_consent_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an administrator granting the permission on behalf of all users.
        """
    ...
    def admin_consent_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_consent_description", value)

    @property
    @pulumi.getter(name="adminConsentDisplayName")
    def admin_consent_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of all users.
        """
    ...
    def admin_consent_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_consent_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Delegated permission description that appears in the end user consent experience, intended to be read by a user consenting on their own behalf.
        """
    ...
    def user_consent_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_consent_description", value)

    @property
    @pulumi.getter(name="userConsentDisplayName")
    def user_consent_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Display name for the delegated permission that appears in the end user consent experience.
        """
    ...
    def user_consent_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ApplicationAppRoleArgsDict(TypedDict):
        allowed_member_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ApplicationAppRoleArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups by setting to `User`, or to other applications (that are accessing this application in a standalone scenario) by setting to `Application`, or to both.
        :param pulumi.Input[builtins.str] description: Description of the app role that appears when the role is being assigned and, if the role functions as an application permissions, during the consent experiences.
        ...
        :param pulumi.Input[builtins.str] id: The unique identifier of the app role. Must be a valid UUID.
               
               > **Tip: Generating a UUID for the `id` field** To generate a value for the `id` field in cases where the actual UUID is not important, you can use the `random_uuid` resource. See the application example in the provider repository.
        :param pulumi.Input[builtins.bool] enabled: Determines if the app role is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] value: The value that is used for the `roles` claim in ID tokens and OAuth 2.0 access tokens that are authenticating an assigned service or user principal
        """
    ...
    def allowed_member_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies whether this app role definition can be assigned to users and groups by setting to `User`, or to other applications (that are accessing this application in a standalone scenario) by setting to `Application`, or to both.
        """
    ...
    def allowed_member_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ApplicationFeatureTagArgsDict(TypedDict):
        custom_single_sign_on: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        gallery: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        hide: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ApplicationFeatureTagArgs:
    def __init__(__self__, *,
                 custom_single_sign_on: Optional[pulumi.Input[builtins.bool]] = None,
                 enterprise: Optional[pulumi.Input[builtins.bool]] = None,
                 gallery: Optional[pulumi.Input[builtins.bool]] = None,
                 hide: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] custom_single_sign_on: Whether this application represents a custom SAML application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] enterprise: Whether this application represents an Enterprise Application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] gallery: Whether this application represents a gallery application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
    ...
    def custom_single_sign_on(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this application represents a custom SAML application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        """
    ...
    def custom_single_sign_on(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def gallery(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this application represents a gallery application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        """
    ...
    @gallery.setter
    def gallery(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "gallery", value)

    @property
    @pulumi.getter
    def hide(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
    ...
    @hide.setter
    def hide(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ApplicationOptionalClaimsAccessTokenArgsDict(TypedDict):
        ...
        """
        additional_properties: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ApplicationOptionalClaimsAccessTokenArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 additional_properties: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 essential: Optional[pulumi.Input[builtins.bool]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the optional claim.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_properties: List of additional properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim. Possible values are: `cloud_displayname`, `dns_domain_and_sam_account_name`, `emit_as_roles`, `include_externally_authenticated_upn_without_hash`, `include_externally_authenticated_upn`, `max_size_limit`, `netbios_domain_and_sam_account_name`, `on_premise_security_identifier`, `sam_account_name`, and `use_guid`.
        :param pulumi.Input[builtins.bool] essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param pulumi.Input[builtins.str] source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
    ...
    def additional_properties(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of additional properties of the claim. If a property exists in this list, it modifies the behaviour of the optional claim. Possible values are: `cloud_displayname`, `dns_domain_and_sam_account_name`, `emit_as_roles`, `include_externally_authenticated_upn_without_hash`, `include_externally_authenticated_upn`, `max_size_limit`, `netbios_domain_and_sam_account_name`, `on_premise_security_identifier`, `sam_account_name`, and `use_guid`.
        """
    ...
    def additional_properties(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ApplicationPasswordArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] display_name: A display name for the password. Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] end_date: The end date until which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] key_id: (Required) The unique key ID for the generated password.
        :param pulumi.Input[builtins.str] start_date: The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`). If this isn't specified, the current date is used.  Changing this field forces a new resource to be created.
        :param pulumi.Input[builtins.str] value: (Required) The generated password for the application.
        """
        pulumi.set(__self__, "display_name", display_name)
...
class ApplicationPublicClientArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` or `ms-appx-web` URL.
        """
...
if not MYPY:
    class ApplicationRequiredResourceAccessArgsDict(TypedDict):
        ...
        """
        resource_app_id: pulumi.Input[builtins.str]
        """
...
class ApplicationRequiredResourceAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_app_id: The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
    ...
    def resource_app_id(self) -> pulumi.Input[builtins.str]:
        """
        The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
    ...
    def resource_app_id(self, value: pulumi.Input[builtins.str]):
...
class ApplicationRequiredResourceAccessResourceAccessArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param pulumi.Input[builtins.str] type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ApplicationSinglePageApplicationArgs:
    def __init__(__self__, *,
                 redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `https` URL.
        """
        if redirect_uris is not None:
            pulumi.set(__self__, "redirect_uris", redirect_uris)
...
if not MYPY:
    class ApplicationWebArgsDict(TypedDict):
        homepage_url: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        logout_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationWebArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `http` URL or a URN.
        """
...
if not MYPY:
    class ApplicationWebImplicitGrantArgsDict(TypedDict):
        access_token_issuance_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether this web application can request an access token using OAuth 2.0 implicit flow.
        """
        id_token_issuance_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ApplicationWebImplicitGrantArgs:
    def __init__(__self__, *,
                 access_token_issuance_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 id_token_issuance_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] access_token_issuance_enabled: Whether this web application can request an access token using OAuth 2.0 implicit flow.
        :param pulumi.Input[builtins.bool] id_token_issuance_enabled: Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    def access_token_issuance_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this web application can request an access token using OAuth 2.0 implicit flow.
        """
    ...
    def access_token_issuance_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "access_token_issuance_enabled", value)

    @property
    @pulumi.getter(name="idTokenIssuanceEnabled")
    def id_token_issuance_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this web application can request an ID token using OAuth 2.0 implicit flow.
        """
    ...
    def id_token_issuance_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ConditionalAccessPolicyConditionsArgsDict(TypedDict):
        ...
        """
        client_app_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        insider_risk_levels: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        service_principal_risk_levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        sign_in_risk_levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        user_risk_levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsArgs:
    def __init__(__self__, *,
                 ...
                 insider_risk_levels: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_principal_risk_levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 sign_in_risk_levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_risk_levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_app_types: A list of client application types included in the policy. Possible values are: `all`, `browser`, `mobileAppsAndDesktopClients`, `exchangeActiveSync`, `easSupported` and `other`.
        ...
        :param pulumi.Input[builtins.str] insider_risk_levels: The insider risk level in the policy. Possible values are: `minor`, `moderate`, `elevated`, `unknownFutureValue`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_principal_risk_levels: A list of service principal sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `none`, `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sign_in_risk_levels: A list of user sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_risk_levels: A list of user risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def client_app_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of client application types included in the policy. Possible values are: `all`, `browser`, `mobileAppsAndDesktopClients`, `exchangeActiveSync`, `easSupported` and `other`.
        """
    ...
    def client_app_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def insider_risk_levels(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The insider risk level in the policy. Possible values are: `minor`, `moderate`, `elevated`, `unknownFutureValue`.
        """
    ...
    def insider_risk_levels(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_principal_risk_levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of service principal sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `none`, `unknownFutureValue`.
        """
    ...
    def service_principal_risk_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "service_principal_risk_levels", value)

    @property
    @pulumi.getter(name="signInRiskLevels")
    def sign_in_risk_levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of user sign-in risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def sign_in_risk_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "sign_in_risk_levels", value)

    @property
    @pulumi.getter(name="userRiskLevels")
    def user_risk_levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of user risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def user_risk_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_risk_levels", value)


if not MYPY:
    class ConditionalAccessPolicyConditionsApplicationsArgsDict(TypedDict):
        excluded_applications: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of application IDs explicitly excluded from the policy. Can also be set to `Office365`.
        """
        included_applications: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        included_user_actions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsApplicationsArgs:
    def __init__(__self__, *,
                 excluded_applications: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_applications: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_user_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_applications: A list of application IDs explicitly excluded from the policy. Can also be set to `Office365`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_applications: A list of application IDs the policy applies to, unless explicitly excluded (in `excluded_applications`). Can also be set to `All`, `None` or `Office365`. Cannot be specified with `included_user_actions`. One of `included_applications` or `included_user_actions` must be specified.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_user_actions: A list of user actions to include. Supported values are `urn:user:registerdevice` and `urn:user:registersecurityinfo`. Cannot be specified with `included_applications`. One of `included_applications` or `included_user_actions` must be specified.
        """
    ...
    def excluded_applications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of application IDs explicitly excluded from the policy. Can also be set to `Office365`.
        """
    ...
    def excluded_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_applications", value)

    @property
    @pulumi.getter(name="includedApplications")
    def included_applications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of application IDs the policy applies to, unless explicitly excluded (in `excluded_applications`). Can also be set to `All`, `None` or `Office365`. Cannot be specified with `included_user_actions`. One of `included_applications` or `included_user_actions` must be specified.
        """
    ...
    def included_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "included_applications", value)

    @property
    @pulumi.getter(name="includedUserActions")
    def included_user_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of user actions to include. Supported values are `urn:user:registerdevice` and `urn:user:registersecurityinfo`. Cannot be specified with `included_applications`. One of `included_applications` or `included_user_actions` must be specified.
        """
    ...
    def included_user_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "included_user_actions", value)


if not MYPY:
    class ConditionalAccessPolicyConditionsClientApplicationsArgsDict(TypedDict):
        excluded_service_principals: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of service principal IDs explicitly excluded in the policy.
        """
        included_service_principals: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsClientApplicationsArgs:
    def __init__(__self__, *,
                 excluded_service_principals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_service_principals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_service_principals: A list of service principal IDs explicitly excluded in the policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_service_principals: A list of service principal IDs explicitly included in the policy. Can be set to `ServicePrincipalsInMyTenant` to include all service principals. This is mandatory value when at least one `excluded_service_principals` is set.
        """
    ...
    def excluded_service_principals(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of service principal IDs explicitly excluded in the policy.
        """
    ...
    def excluded_service_principals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_service_principals", value)

    @property
    @pulumi.getter(name="includedServicePrincipals")
    def included_service_principals(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of service principal IDs explicitly included in the policy. Can be set to `ServicePrincipalsInMyTenant` to include all service principals. This is mandatory value when at least one `excluded_service_principals` is set.
        """
    ...
    def included_service_principals(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ConditionalAccessPolicyConditionsDevicesFilterArgs:
    def __init__(__self__, *,
                 ...
                 rule: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] mode: Whether to include in, or exclude from, matching devices from the policy. Supported values are `include` or `exclude`.
        :param pulumi.Input[builtins.str] rule: Condition filter to match devices. For more information, see [official documentation](https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-condition-filters-for-devices#supported-operators-and-device-properties-for-filters).
        """
...
if not MYPY:
    class ConditionalAccessPolicyConditionsLocationsArgsDict(TypedDict):
        included_locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        """
        excluded_locations: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsLocationsArgs:
    def __init__(__self__, *,
                 included_locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 excluded_locations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_locations: A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_locations: A list of location IDs excluded from scope of policy. Can also be set to `AllTrusted`.
        """
    ...
    def included_locations(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        """
    ...
    def included_locations(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "included_locations", value)

    @property
    @pulumi.getter(name="excludedLocations")
    def excluded_locations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of location IDs excluded from scope of policy. Can also be set to `AllTrusted`.
        """
    ...
    def excluded_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_locations", value)


if not MYPY:
    class ConditionalAccessPolicyConditionsPlatformsArgsDict(TypedDict):
        included_platforms: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        excluded_platforms: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsPlatformsArgs:
    def __init__(__self__, *,
                 included_platforms: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 excluded_platforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_platforms: A list of platforms the policy applies to, unless explicitly excluded. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_platforms: A list of platforms explicitly excluded from the policy. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def included_platforms(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of platforms the policy applies to, unless explicitly excluded. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def included_platforms(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "included_platforms", value)

    @property
    @pulumi.getter(name="excludedPlatforms")
    def excluded_platforms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of platforms explicitly excluded from the policy. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def excluded_platforms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_platforms", value)


if not MYPY:
    class ConditionalAccessPolicyConditionsUsersArgsDict(TypedDict):
        excluded_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        excluded_roles: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of role IDs excluded from scope of policy.
        """
        excluded_users: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of user IDs excluded from scope of policy and/or `GuestsOrExternalUsers`.
        """
        included_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        included_roles: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of role IDs in scope of policy unless explicitly excluded.
        """
        included_users: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyConditionsUsersArgs:
    def __init__(__self__, *,
                 excluded_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 excluded_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 excluded_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 included_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_groups: A list of group IDs excluded from scope of policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_roles: A list of role IDs excluded from scope of policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_users: A list of user IDs excluded from scope of policy and/or `GuestsOrExternalUsers`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_groups: A list of group IDs in scope of policy unless explicitly excluded.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_roles: A list of role IDs in scope of policy unless explicitly excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_users: A list of user IDs in scope of policy unless explicitly excluded, or `None` or `All` or `GuestsOrExternalUsers`.
    ...
    def excluded_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of group IDs excluded from scope of policy.
        """
    ...
    def excluded_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def excluded_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of role IDs excluded from scope of policy.
        """
    ...
    def excluded_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_roles", value)

    @property
    @pulumi.getter(name="excludedUsers")
    def excluded_users(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of user IDs excluded from scope of policy and/or `GuestsOrExternalUsers`.
        """
    ...
    def excluded_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_users", value)

    @property
    @pulumi.getter(name="includedGroups")
    def included_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of group IDs in scope of policy unless explicitly excluded.
        """
    ...
    def included_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def included_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of role IDs in scope of policy unless explicitly excluded.
        """
    ...
    def included_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "included_roles", value)

    @property
    @pulumi.getter(name="includedUsers")
    def included_users(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of user IDs in scope of policy unless explicitly excluded, or `None` or `All` or `GuestsOrExternalUsers`.
    ...
    def included_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserArgsDict(TypedDict):
        guest_or_external_user_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] guest_or_external_user_types: A list of guest or external user types. Possible values are: `b2bCollaborationGuest`, `b2bCollaborationMember`, `b2bDirectConnectUser`, `internalGuest`, `none`, `otherExternalUser`, `serviceProvider`, `unknownFutureValue`.
    ...
    def guest_or_external_user_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of guest or external user types. Possible values are: `b2bCollaborationGuest`, `b2bCollaborationMember`, `b2bDirectConnectUser`, `internalGuest`, `none`, `otherExternalUser`, `serviceProvider`, `unknownFutureValue`.
        """
    ...
    def guest_or_external_user_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserExternalTenantArgsDict(TypedDict):
        membership_kind: pulumi.Input[builtins.str]
        """
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserExternalTenantArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] membership_kind: The external tenant membership kind. Possible values are: `all`, `enumerated`, `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: A list tenant IDs. Can only be specified if `membership_kind` is `enumerated`.
        """
    ...
    def membership_kind(self) -> pulumi.Input[builtins.str]:
        """
        The external tenant membership kind. Possible values are: `all`, `enumerated`, `unknownFutureValue`.
        """
    ...
    def membership_kind(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ConditionalAccessPolicyGrantControlsArgsDict(TypedDict):
        ...
        """
        authentication_strength_policy_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        built_in_controls: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        """
        custom_authentication_factors: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of custom controls IDs required by the policy.
        """
        terms_of_uses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConditionalAccessPolicyGrantControlsArgs:
    def __init__(__self__, *,
                 operator: pulumi.Input[builtins.str],
                 authentication_strength_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 built_in_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 custom_authentication_factors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 terms_of_uses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] operator: Defines the relationship of the grant controls. Possible values are: `AND`, `OR`.
        :param pulumi.Input[builtins.str] authentication_strength_policy_id: ID of an Authentication Strength Policy to use in this policy. When using a hard-coded ID, the UUID value should be prefixed with: `/policies/authenticationStrengthPolicies/`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] built_in_controls: List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_authentication_factors: List of custom controls IDs required by the policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] terms_of_uses: List of terms of use IDs required by the policy.
    ...
    def authentication_strength_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of an Authentication Strength Policy to use in this policy. When using a hard-coded ID, the UUID value should be prefixed with: `/policies/authenticationStrengthPolicies/`.
        """
    ...
    def authentication_strength_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authentication_strength_policy_id", value)

    @property
    @pulumi.getter(name="builtInControls")
    def built_in_controls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        """
    ...
    def built_in_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "built_in_controls", value)

    @property
    @pulumi.getter(name="customAuthenticationFactors")
    def custom_authentication_factors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of custom controls IDs required by the policy.
        """
    ...
    def custom_authentication_factors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "custom_authentication_factors", value)

    @property
    @pulumi.getter(name="termsOfUses")
    def terms_of_uses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of terms of use IDs required by the policy.
    ...
    def terms_of_uses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "terms_of_uses", value)


if not MYPY:
    class ConditionalAccessPolicySessionControlsArgsDict(TypedDict):
        application_enforced_restrictions_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether application enforced restrictions are enabled. Defaults to `false`.

        > Only Office 365, Exchange Online and Sharepoint Online support application enforced restrictions.
        """
        cloud_app_security_policy: NotRequired[pulumi.Input[builtins.str]]
        """
        Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        """
        disable_resilience_defaults: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        sign_in_frequency_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        """
        sign_in_frequency_period: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConditionalAccessPolicySessionControlsArgs:
    def __init__(__self__, *,
                 application_enforced_restrictions_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cloud_app_security_policy: Optional[pulumi.Input[builtins.str]] = None,
                 disable_resilience_defaults: Optional[pulumi.Input[builtins.bool]] = None,
                 persistent_browser_mode: Optional[pulumi.Input[builtins.str]] = None,
                 sign_in_frequency: Optional[pulumi.Input[builtins.int]] = None,
                 sign_in_frequency_authentication_type: Optional[pulumi.Input[builtins.str]] = None,
                 sign_in_frequency_interval: Optional[pulumi.Input[builtins.str]] = None,
                 sign_in_frequency_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] application_enforced_restrictions_enabled: Whether application enforced restrictions are enabled. Defaults to `false`.
               
               > Only Office 365, Exchange Online and Sharepoint Online support application enforced restrictions.
        :param pulumi.Input[builtins.str] cloud_app_security_policy: Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        :param pulumi.Input[builtins.bool] disable_resilience_defaults: Disables [resilience defaults](https://learn.microsoft.com/en-us/azure/active-directory/conditional-access/resilience-defaults). Defaults to `false`.
        :param pulumi.Input[builtins.str] persistent_browser_mode: Session control to define whether to persist cookies. Possible values are: `always` or `never`.
        :param pulumi.Input[builtins.int] sign_in_frequency: Number of days or hours to enforce sign-in frequency. Required when `sign_in_frequency_period` is specified.
        :param pulumi.Input[builtins.str] sign_in_frequency_authentication_type: Authentication type for enforcing sign-in frequency. Possible values are: `primaryAndSecondaryAuthentication` or `secondaryAuthentication`. Defaults to `primaryAndSecondaryAuthentication`.
        :param pulumi.Input[builtins.str] sign_in_frequency_interval: The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        :param pulumi.Input[builtins.str] sign_in_frequency_period: The time period to enforce sign-in frequency. Possible values are: `hours` or `days`. Required when `sign_in_frequency_period` is specified.
        """
    ...
    def application_enforced_restrictions_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether application enforced restrictions are enabled. Defaults to `false`.
    ...
    def application_enforced_restrictions_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "application_enforced_restrictions_enabled", value)

    @property
    @pulumi.getter(name="cloudAppSecurityPolicy")
    def cloud_app_security_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        """
    ...
    def cloud_app_security_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloud_app_security_policy", value)

    @property
    @pulumi.getter(name="disableResilienceDefaults")
    def disable_resilience_defaults(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Disables [resilience defaults](https://learn.microsoft.com/en-us/azure/active-directory/conditional-access/resilience-defaults). Defaults to `false`.
        """
    ...
    def disable_resilience_defaults(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_resilience_defaults", value)

    @property
    @pulumi.getter(name="persistentBrowserMode")
    def persistent_browser_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Session control to define whether to persist cookies. Possible values are: `always` or `never`.
        """
    ...
    def persistent_browser_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "persistent_browser_mode", value)

    @property
    @pulumi.getter(name="signInFrequency")
    def sign_in_frequency(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of days or hours to enforce sign-in frequency. Required when `sign_in_frequency_period` is specified.
        """
    ...
    def sign_in_frequency(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sign_in_frequency", value)

    @property
    @pulumi.getter(name="signInFrequencyAuthenticationType")
    def sign_in_frequency_authentication_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Authentication type for enforcing sign-in frequency. Possible values are: `primaryAndSecondaryAuthentication` or `secondaryAuthentication`. Defaults to `primaryAndSecondaryAuthentication`.
        """
    ...
    def sign_in_frequency_authentication_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sign_in_frequency_authentication_type", value)

    @property
    @pulumi.getter(name="signInFrequencyInterval")
    def sign_in_frequency_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        """
    ...
    def sign_in_frequency_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sign_in_frequency_interval", value)

    @property
    @pulumi.getter(name="signInFrequencyPeriod")
    def sign_in_frequency_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time period to enforce sign-in frequency. Possible values are: `hours` or `days`. Required when `sign_in_frequency_period` is specified.
        """
    ...
    def sign_in_frequency_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sign_in_frequency_period", value)


if not MYPY:
    class CustomDirectoryRolePermissionArgsDict(TypedDict):
        allowed_resource_actions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class CustomDirectoryRolePermissionArgs:
    def __init__(__self__, *,
                 allowed_resource_actions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_resource_actions: A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
        pulumi.set(__self__, "allowed_resource_actions", allowed_resource_actions)

    @property
    @pulumi.getter(name="allowedResourceActions")
    def allowed_resource_actions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
    ...
    def allowed_resource_actions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class GroupDynamicMembershipArgs:
    def __init__(__self__, *,
                 ...
                 rule: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param pulumi.Input[builtins.str] rule: The rule that determines membership of this group. For more information, see official documentation on [membership rules syntax](https://docs.microsoft.com/en-gb/azure/active-directory/enterprise-users/groups-dynamic-membership).
...
if not MYPY:
    class GroupRoleManagementPolicyActivationRulesArgsDict(TypedDict):
        ...
        """
        require_approval: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is approval required for activation. If `true` an `approval_stage` block must be provided.
        """
        require_justification: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is a justification required during activation of the role.
        """
        require_multifactor_authentication: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        require_ticket_info: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is ticket information requrired during activation of the role.
        """
        required_conditional_access_authentication_context: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupRoleManagementPolicyActivationRulesArgs:
    def __init__(__self__, *,
                 ...
                 require_justification: Optional[pulumi.Input[builtins.bool]] = None,
                 require_multifactor_authentication: Optional[pulumi.Input[builtins.bool]] = None,
                 require_ticket_info: Optional[pulumi.Input[builtins.bool]] = None,
                 required_conditional_access_authentication_context: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] maximum_duration: The maximum length of time an activated role can be valid, in an ISO8601 Duration format (e.g. `PT8H`). Valid range is `PT30M` to `PT23H30M`, in 30 minute increments, or `PT1D`.
        :param pulumi.Input[builtins.bool] require_approval: Is approval required for activation. If `true` an `approval_stage` block must be provided.
        :param pulumi.Input[builtins.bool] require_justification: Is a justification required during activation of the role.
        :param pulumi.Input[builtins.bool] require_multifactor_authentication: Is multi-factor authentication required to activate the role. Conflicts with `required_conditional_access_authentication_context`.
        :param pulumi.Input[builtins.bool] require_ticket_info: Is ticket information requrired during activation of the role.
        :param pulumi.Input[builtins.str] required_conditional_access_authentication_context: The Entra ID Conditional Access context that must be present for activation (e.g `c1`). Conflicts with `require_multifactor_authentication`.
        """
    ...
    def require_justification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is a justification required during activation of the role.
        """
    ...
    def require_justification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_justification", value)

    @property
    @pulumi.getter(name="requireMultifactorAuthentication")
    def require_multifactor_authentication(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is multi-factor authentication required to activate the role. Conflicts with `required_conditional_access_authentication_context`.
        """
    ...
    def require_multifactor_authentication(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_multifactor_authentication", value)

    @property
    @pulumi.getter(name="requireTicketInfo")
    def require_ticket_info(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is ticket information requrired during activation of the role.
        """
    ...
    def require_ticket_info(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_ticket_info", value)

    @property
    @pulumi.getter(name="requiredConditionalAccessAuthenticationContext")
    def required_conditional_access_authentication_context(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Entra ID Conditional Access context that must be present for activation (e.g `c1`). Conflicts with `require_multifactor_authentication`.
        """
    ...
    def required_conditional_access_authentication_context(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] object_id: The ID of the object which will act as an approver.
        :param pulumi.Input[builtins.str] type: The type of object acting as an approver. Possible options are `singleUser` and `groupMembers`.
        """
        pulumi.set(__self__, "object_id", object_id)
        if type is not None:
            pulumi.set(__self__, "type", type)
...
if not MYPY:
    class GroupRoleManagementPolicyActiveAssignmentRulesArgsDict(TypedDict):
        expiration_required: NotRequired[pulumi.Input[builtins.bool]]
        """
        Must an assignment have an expiry date. `false` allows permanent assignment.
        """
        expire_after: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupRoleManagementPolicyActiveAssignmentRulesArgs:
    def __init__(__self__, *,
                 expiration_required: Optional[pulumi.Input[builtins.bool]] = None,
                 expire_after: Optional[pulumi.Input[builtins.str]] = None,
                 require_justification: Optional[pulumi.Input[builtins.bool]] = None,
                 require_multifactor_authentication: Optional[pulumi.Input[builtins.bool]] = None,
                 require_ticket_info: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] expiration_required: Must an assignment have an expiry date. `false` allows permanent assignment.
        :param pulumi.Input[builtins.str] expire_after: The maximum length of time an assignment can be valid, as an ISO8601 duration. Permitted values: `P15D`, `P30D`, `P90D`, `P180D`, or `P365D`.
        :param pulumi.Input[builtins.bool] require_justification: Is a justification required to create new assignments.
        :param pulumi.Input[builtins.bool] require_multifactor_authentication: Is multi-factor authentication required to create new assignments.
        :param pulumi.Input[builtins.bool] require_ticket_info: Is ticket information required to create new assignments.
    ...
    def expiration_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Must an assignment have an expiry date. `false` allows permanent assignment.
        """
    ...
    def expiration_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "expiration_required", value)

    @property
    @pulumi.getter(name="expireAfter")
    def expire_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum length of time an assignment can be valid, as an ISO8601 duration. Permitted values: `P15D`, `P30D`, `P90D`, `P180D`, or `P365D`.
        """
    ...
    @expire_after.setter
    def expire_after(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgsDict(TypedDict):
        default_recipients: pulumi.Input[builtins.bool]
        """
        Whether the default recipients are notified
        """
        notification_level: pulumi.Input[builtins.str]
        """
        What level of notifications are sent
        """
        additional_recipients: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs:
    def __init__(__self__, *,
                 default_recipients: pulumi.Input[builtins.bool],
                 notification_level: pulumi.Input[builtins.str],
                 additional_recipients: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] default_recipients: Whether the default recipients are notified
        :param pulumi.Input[builtins.str] notification_level: What level of notifications are sent
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_recipients: The additional recipients to notify
        """
    ...
    def default_recipients(self) -> pulumi.Input[builtins.bool]:
        """
        Whether the default recipients are notified
        """
    ...
    def default_recipients(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "default_recipients", value)

    @property
    @pulumi.getter(name="notificationLevel")
    def notification_level(self) -> pulumi.Input[builtins.str]:
        """
        What level of notifications are sent
        """
    ...
    def notification_level(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "notification_level", value)

    @property
    @pulumi.getter(name="additionalRecipients")
    def additional_recipients(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The additional recipients to notify
        """
    ...
    def additional_recipients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class InvitationMessageArgsDict(TypedDict):
        additional_recipients: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InvitationMessageArgs:
    def __init__(__self__, *,
                 additional_recipients: Optional[pulumi.Input[builtins.str]] = None,
                 body: Optional[pulumi.Input[builtins.str]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] additional_recipients: Email addresses of additional recipients the invitation message should be sent to. Only 1 additional recipient is currently supported by Azure.
        :param pulumi.Input[builtins.str] body: Customized message body you want to send if you don't want to send the default message. Cannot be specified with `language`.
        :param pulumi.Input[builtins.str] language: The language you want to send the default message in. The value specified must be in ISO 639 format. Defaults to `en-US`. Cannot be specified with `body`.
        """
        if additional_recipients is not None:
            pulumi.set(__self__, "additional_recipients", additional_recipients)
        if body is not None:
    ...
    @property
    @pulumi.getter(name="additionalRecipients")
    def additional_recipients(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Email addresses of additional recipients the invitation message should be sent to. Only 1 additional recipient is currently supported by Azure.
        """
        return pulumi.get(self, "additional_recipients")
    ...
    @additional_recipients.setter
    def additional_recipients(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "additional_recipients", value)
...
if not MYPY:
    class NamedLocationCountryArgsDict(TypedDict):
        countries_and_regions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        List of countries and/or regions in two-letter format specified by ISO 3166-2.
        """
        country_lookup_method: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        include_unknown_countries_and_regions: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class NamedLocationCountryArgs:
    def __init__(__self__, *,
                 countries_and_regions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 country_lookup_method: Optional[pulumi.Input[builtins.str]] = None,
                 include_unknown_countries_and_regions: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] countries_and_regions: List of countries and/or regions in two-letter format specified by ISO 3166-2.
        :param pulumi.Input[builtins.str] country_lookup_method: Method of detecting country the user is located in. Possible values are `clientIpAddress` for IP-based location and `authenticatorAppGps` for Authenticator app GPS-based location.  Defaults to `clientIpAddress`.
        :param pulumi.Input[builtins.bool] include_unknown_countries_and_regions: Whether IP addresses that don't map to a country or region should be included in the named location. Defaults to `false`.
        """
    ...
    def countries_and_regions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of countries and/or regions in two-letter format specified by ISO 3166-2.
        """
    ...
    def countries_and_regions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "countries_and_regions", value)

    @property
    @pulumi.getter(name="countryLookupMethod")
    def country_lookup_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Method of detecting country the user is located in. Possible values are `clientIpAddress` for IP-based location and `authenticatorAppGps` for Authenticator app GPS-based location.  Defaults to `clientIpAddress`.
        """
    ...
    def country_lookup_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "country_lookup_method", value)

    @property
    @pulumi.getter(name="includeUnknownCountriesAndRegions")
    def include_unknown_countries_and_regions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether IP addresses that don't map to a country or region should be included in the named location. Defaults to `false`.
        """
    ...
    def include_unknown_countries_and_regions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_unknown_countries_and_regions", value)


if not MYPY:
    class NamedLocationIpArgsDict(TypedDict):
        ip_ranges: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class NamedLocationIpArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_ranges: List of IP address ranges in IPv4 CIDR format (e.g. `1.2.3.4/32`) or any allowable IPv6 format from IETF RFC596. Each CIDR prefix must be `/8` or larger.
        :param pulumi.Input[builtins.bool] trusted: Whether the named location is trusted. Defaults to `false`.
        """
    ...
    def ip_ranges(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of IP address ranges in IPv4 CIDR format (e.g. `1.2.3.4/32`) or any allowable IPv6 format from IETF RFC596. Each CIDR prefix must be `/8` or larger.
        """
    ...
    @ip_ranges.setter
    def ip_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class ServicePrincipalAppRoleArgsDict(TypedDict):
        allowed_member_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ServicePrincipalAppRoleArgs:
    def __init__(__self__, *,
                 allowed_member_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_member_types: Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are: `User` and `Application`, or both.
        :param pulumi.Input[builtins.str] description: A description of the service principal provided for internal end-users.
        :param pulumi.Input[builtins.str] display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether the permission scope is enabled.
        :param pulumi.Input[builtins.str] id: The unique identifier of the delegated permission.
        :param pulumi.Input[builtins.str] value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
    ...
    @property
    @pulumi.getter(name="allowedMemberTypes")
    def allowed_member_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies whether this app role definition can be assigned to users and groups, or to other applications (that are accessing this application in a standalone scenario). Possible values are: `User` and `Application`, or both.
        """
        return pulumi.get(self, "allowed_member_types")
    ...
    @allowed_member_types.setter
    def allowed_member_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_member_types", value)
...
if not MYPY:
    class ServicePrincipalFeatureArgsDict(TypedDict):
        custom_single_sign_on_app: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether this service principal represents a custom SAML application
        """
        enterprise_application: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether this service principal represents an Enterprise Application
        """
        gallery_application: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether this service principal represents a gallery application
        """
        visible_to_users: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServicePrincipalFeatureArgs:
    def __init__(__self__, *,
                 custom_single_sign_on_app: Optional[pulumi.Input[builtins.bool]] = None,
                 enterprise_application: Optional[pulumi.Input[builtins.bool]] = None,
                 gallery_application: Optional[pulumi.Input[builtins.bool]] = None,
                 visible_to_users: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] custom_single_sign_on_app: Whether this service principal represents a custom SAML application
        :param pulumi.Input[builtins.bool] enterprise_application: Whether this service principal represents an Enterprise Application
        :param pulumi.Input[builtins.bool] gallery_application: Whether this service principal represents a gallery application
        :param pulumi.Input[builtins.bool] visible_to_users: Whether this app is visible to users in My Apps and Office 365 Launcher
        """
    ...
    def custom_single_sign_on_app(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this service principal represents a custom SAML application
        """
    ...
    def custom_single_sign_on_app(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "custom_single_sign_on_app", value)

    @property
    @pulumi.getter(name="enterpriseApplication")
    def enterprise_application(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this service principal represents an Enterprise Application
        """
    ...
    def enterprise_application(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enterprise_application", value)

    @property
    @pulumi.getter(name="galleryApplication")
    def gallery_application(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this service principal represents a gallery application
        """
    ...
    def gallery_application(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "gallery_application", value)

    @property
    @pulumi.getter(name="visibleToUsers")
    def visible_to_users(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this app is visible to users in My Apps and Office 365 Launcher
        """
    ...
    def visible_to_users(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ServicePrincipalFeatureTagArgs:
    def __init__(__self__, *,
                 ...
                 hide: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] custom_single_sign_on: Whether this service principal represents a custom SAML application. Enabling this will assign the `WindowsAzureActiveDirectoryCustomSingleSignOnApplication` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] enterprise: Whether this service principal represents an Enterprise Application. Enabling this will assign the `WindowsAzureActiveDirectoryIntegratedApp` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] gallery: Whether this service principal represents a gallery application. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param pulumi.Input[builtins.bool] hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
...
if not MYPY:
    class ServicePrincipalSamlSingleSignOnArgsDict(TypedDict):
        relay_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServicePrincipalSamlSingleSignOnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] relay_state: The relative URI the service provider would redirect to after completion of the single sign-on flow.
        """
...
class SynchronizationJobProvisionOnDemandParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] rule_id: The identifier of the synchronization rule to be applied. This rule ID is defined in the schema for a given synchronization job or template.
...
class SynchronizationJobProvisionOnDemandParameterSubjectArgs:
    def __init__(__self__, *,
                 ...
                 object_type_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] object_id: The identifier of an object to which a synchronization job is to be applied. Can be one of the following: (1) An onPremisesDistinguishedName for synchronization from Active Directory to Azure AD. (2) The user ID for synchronization from Azure AD to a third-party. (3) The Worker ID of the Workday worker for synchronization from Workday to either Active Directory or Azure AD.
        :param pulumi.Input[builtins.str] object_type_name: The type of the object to which a synchronization job is to be applied. Can be one of the following: `user` for synchronizing between Active Directory and Azure AD, `User` for synchronizing a user between Azure AD and a third-party application, `Worker` for synchronization a user between Workday and either Active Directory or Azure AD, `Group` for synchronizing a group between Azure AD and a third-party application.
        """
        pulumi.set(__self__, "object_id", object_id)
...
class SynchronizationJobScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] expiration: Date and time when this job will expire, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).
        :param pulumi.Input[builtins.str] interval: The interval between synchronization iterations ISO8601. E.g. PT40M run every 40 minutes.
...
class SynchronizationSecretCredentialArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key of the secret.
