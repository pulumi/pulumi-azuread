...
class AccessPackageAssignmentPolicyApprovalSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] requestor_justification_required: Whether a requestor is required to provide a justification to request an access package. Justification is visible to approvers and the requestor.
        """
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] approver_justification_required: Whether an approver must provide a justification for their decision. Justification is visible to other approvers and the requestor
        :param pulumi.Input[_builtins.int] enable_alternative_approval_in_days: Forward to alternate approver(s) after how many days?
    ...
    def approval_timeout_in_days(self) -> pulumi.Input[_builtins.int]:
        """
        Decision must be made in how many days? If a request is not approved within this time period after it is made, it will be automatically rejected
        """
    ...
    def approval_timeout_in_days(self, value: pulumi.Input[_builtins.int]):
...
class AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApproverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] object_id: The object ID of the subject
        """
    ...
    def subject_type(self) -> pulumi.Input[_builtins.str]:
        """
        Type of users
        """
    ...
    @subject_type.setter
    def subject_type(self, value: pulumi.Input[_builtins.str]):
...
class AccessPackageAssignmentPolicyAssignmentReviewSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] approver_justification_required: Whether a reviewer needs to provide a justification for their decision. Justification is visible to other reviewers and the requestor.
        :param pulumi.Input[_builtins.int] duration_in_days: How many days each occurrence of the access review series will run.
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable assignment review.
        :param pulumi.Input[_builtins.str] review_frequency: This will determine how often the access review campaign runs, valid values are `weekly`, `monthly`, `quarterly`, `halfyearly`, or `annual`.
        :param pulumi.Input[_builtins.str] review_type: Self-review or specific reviewers. Valid values are `Manager`, `Reviewers`, or `Self`.
        ...
        :param pulumi.Input[_builtins.str] starting_on: This is the date the access review campaign will start on, formatted as an RFC3339 date string in UTC(e.g. 2018-01-01T01:02:03Z), default is now. Once an access review has been created, you cannot update its start date
        """
...
class AccessPackageAssignmentPolicyQuestionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] required: Whether this question is required.
        :param pulumi.Input[_builtins.int] sequence: The sequence number of this question.
        """
...
class AccessPackageAssignmentPolicyQuestionChoiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] actual_value: The actual value of this choice
    ...
    def actual_value(self) -> pulumi.Input[_builtins.str]:
        """
        The actual value of this choice
        """
    ...
    @actual_value.setter
    def actual_value(self, value: pulumi.Input[_builtins.str]):
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueArgs:
    ...
    def default_text(self) -> pulumi.Input[_builtins.str]:
        """
        The default text of this question
        """
    ...
    @default_text.setter
    def default_text(self, value: pulumi.Input[_builtins.str]):
...
class AccessPackageAssignmentPolicyQuestionChoiceDisplayValueLocalizedTextArgs:
    def __init__(__self__, *,
                 ...
                 language_code: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] content: The localized content of this question
        :param pulumi.Input[_builtins.str] language_code: The language code of this question content
        """
...
class ApplicationApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] requested_access_token_version: The access token version expected by this resource. Must be one of `1` or `2`, and must be `2` when `sign_in_audience` is either `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount` Defaults to `1`.
        """
...
class ApplicationApiOauth2PermissionScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Determines if the permission scope is enabled. Defaults to `true`.
...
class ApplicationAppRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: The unique identifier of the app role. Must be a valid UUID.
...
class ApplicationFeatureTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] gallery: Whether this application represents a gallery application for linked service principals. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
...
class ApplicationOptionalClaimsAccessTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] essential: Whether the claim specified by the client is necessary to ensure a smooth authorization experience.
        :param pulumi.Input[_builtins.str] source: The source of the claim. If `source` is absent, the claim is a predefined optional claim. If `source` is `user`, the value of `name` is the extension property from the user object.
        """
...
class ApplicationPasswordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key_id: (Required) The unique key ID for the generated password.
        ...
        :param pulumi.Input[_builtins.str] value: (Required) The generated password for the application.
        """
        pulumi.set(__self__, "display_name", display_name)
...
class ApplicationRequiredResourceAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_app_id: The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
    ...
    def resource_app_id(self) -> pulumi.Input[_builtins.str]:
        """
        The unique identifier for the resource that the application requires access to. This should be the Application ID of the target application.
    ...
    def resource_app_id(self, value: pulumi.Input[_builtins.str]):
...
class ApplicationRequiredResourceAccessResourceAccessArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The unique identifier for an app role or OAuth2 permission scope published by the resource application.
        :param pulumi.Input[_builtins.str] type: Specifies whether the `id` property references an app role or an OAuth2 permission scope. Possible values are `Role` or `Scope`.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class ApplicationWebArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] redirect_uris: A set of URLs where user tokens are sent for sign-in, or the redirect URIs where OAuth 2.0 authorization codes and access tokens are sent. Must be a valid `http` URL or a URN.
        """
...
class ConditionalAccessPolicyConditionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] authentication_flow_transfer_methods: A list of authentication flow transfer methods included in the policy. Possible values are: `authenticationTransfer` and `deviceCodeFlow`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] user_risk_levels: A list of user risk levels included in the policy. Possible values are: `low`, `medium`, `high`, `hidden`, `none`, `unknownFutureValue`.
        """
    ...
    def client_app_types(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of client application types included in the policy. Possible values are: `all`, `browser`, `mobileAppsAndDesktopClients`, `exchangeActiveSync`, `easSupported` and `other`.
        """
    ...
    def client_app_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ConditionalAccessPolicyConditionsLocationsArgs:
    ...
    def included_locations(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of location IDs in scope of policy unless explicitly excluded. Can also be set to `All`, or `AllTrusted`.
        """
    ...
    def included_locations(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ConditionalAccessPolicyConditionsPlatformsArgs:
    ...
    def included_platforms(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of platforms the policy applies to, unless explicitly excluded. Possible values are: `all`, `android`, `iOS`, `linux`, `macOS`, `windows`, `windowsPhone` or `unknownFutureValue`.
        """
    ...
    def included_platforms(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserArgs:
    ...
    def guest_or_external_user_types(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of guest or external user types. Possible values are: `b2bCollaborationGuest`, `b2bCollaborationMember`, `b2bDirectConnectUser`, `internalGuest`, `none`, `otherExternalUser`, `serviceProvider`, `unknownFutureValue`.
        """
    ...
    def guest_or_external_user_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUserExternalTenantArgs:
    ...
    def membership_kind(self) -> pulumi.Input[_builtins.str]:
        """
        The external tenant membership kind. Possible values are: `all`, `enumerated`, `unknownFutureValue`.
        """
    ...
    def membership_kind(self, value: pulumi.Input[_builtins.str]):
...
class ConditionalAccessPolicyGrantControlsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] built_in_controls: List of built-in controls required by the policy. Possible values are: `block`, `mfa`, `approvedApplication`, `compliantApplication`, `compliantDevice`, `domainJoinedDevice`, `passwordChange` or `unknownFutureValue`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] custom_authentication_factors: List of custom controls IDs required by the policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] terms_of_uses: List of terms of use IDs required by the policy.
...
class ConditionalAccessPolicySessionControlsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] application_enforced_restrictions_enabled: Whether application enforced restrictions are enabled. Defaults to `false`.
               ...
               > Only Office 365, Exchange Online and Sharepoint Online support application enforced restrictions.
        :param pulumi.Input[_builtins.str] cloud_app_security_policy: Enables cloud app security and specifies the cloud app security policy to use. Possible values are: `blockDownloads`, `mcasConfigured`, `monitorOnly` or `unknownFutureValue`.
        :param pulumi.Input[_builtins.bool] disable_resilience_defaults: Disables [resilience defaults](https://learn.microsoft.com/en-us/azure/active-directory/conditional-access/resilience-defaults). Defaults to `false`.
        :param pulumi.Input[_builtins.str] persistent_browser_mode: Session control to define whether to persist cookies. Possible values are: `always` or `never`.
        :param pulumi.Input[_builtins.int] sign_in_frequency: Number of days or hours to enforce sign-in frequency. Required when `sign_in_frequency_period` is specified.
        :param pulumi.Input[_builtins.str] sign_in_frequency_authentication_type: Authentication type for enforcing sign-in frequency. Possible values are: `primaryAndSecondaryAuthentication` or `secondaryAuthentication`. Defaults to `primaryAndSecondaryAuthentication`.
        :param pulumi.Input[_builtins.str] sign_in_frequency_interval: The interval to apply to sign-in frequency control. Possible values are: `timeBased` or `everyTime`. Defaults to `timeBased`.
        :param pulumi.Input[_builtins.str] sign_in_frequency_period: The time period to enforce sign-in frequency. Possible values are: `hours` or `days`. Required when `sign_in_frequency_period` is specified.
        """
...
class CustomDirectoryRolePermissionArgs:
    def __init__(__self__, *,
                 allowed_resource_actions: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_resource_actions: A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
        pulumi.set(__self__, "allowed_resource_actions", allowed_resource_actions)

    @_builtins.property
    @pulumi.getter(name="allowedResourceActions")
    def allowed_resource_actions(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A set of tasks that can be performed on a resource. For more information, see the [Permissions Reference](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference) documentation.
        """
    ...
    def allowed_resource_actions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class GroupDynamicMembershipArgs:
    def __init__(__self__, *,
                 ...
                 rule: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether rule processing is "On" (true) or "Paused" (false).
        :param pulumi.Input[_builtins.str] rule: The rule that determines membership of this group. For more information, see official documentation on [membership rules syntax](https://docs.microsoft.com/en-gb/azure/active-directory/enterprise-users/groups-dynamic-membership).
...
class GroupRoleManagementPolicyActiveAssignmentRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] require_justification: Is a justification required to create new assignments.
        :param pulumi.Input[_builtins.bool] require_multifactor_authentication: Is multi-factor authentication required to create new assignments.
        :param pulumi.Input[_builtins.bool] require_ticket_info: Is ticket information required to create new assignments.
...
class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] additional_recipients: The additional recipients to notify
        """
    ...
    def default_recipients(self) -> pulumi.Input[_builtins.bool]:
        """
        Whether the default recipients are notified
        """
    ...
    def default_recipients(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "default_recipients", value)

    @_builtins.property
    @pulumi.getter(name="notificationLevel")
    def notification_level(self) -> pulumi.Input[_builtins.str]:
        """
        What level of notifications are sent
        """
    ...
    def notification_level(self, value: pulumi.Input[_builtins.str]):
...
class InvitationMessageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] language: The language you want to send the default message in. The value specified must be in ISO 639 format. Defaults to `en-US`. Cannot be specified with `body`.
        """
        if additional_recipients is not None:
            pulumi.set(__self__, "additional_recipients", additional_recipients)
        if body is not None:
...
class NamedLocationCountryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] include_unknown_countries_and_regions: Whether IP addresses that don't map to a country or region should be included in the named location. Defaults to `false`.
        """
    ...
    def countries_and_regions(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        List of countries and/or regions in two-letter format specified by ISO 3166-2.
        """
    ...
    def countries_and_regions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ServicePrincipalAppRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: Display name for the app role that appears during app role assignment and in consent experiences.
        :param pulumi.Input[_builtins.bool] enabled: Specifies whether the permission scope is enabled.
        :param pulumi.Input[_builtins.str] id: The unique identifier of the delegated permission.
        :param pulumi.Input[_builtins.str] value: The value that is used for the `scp` claim in OAuth 2.0 access tokens.
        """
...
class ServicePrincipalFeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] gallery_application: Whether this service principal represents a gallery application
        :param pulumi.Input[_builtins.bool] visible_to_users: Whether this app is visible to users in My Apps and Office 365 Launcher
        """
...
class ServicePrincipalFeatureTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] gallery: Whether this service principal represents a gallery application. Enabling this will assign the `WindowsAzureActiveDirectoryGalleryApplicationNonPrimaryV1` tag. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] hide: Whether this app is invisible to users in My Apps and Office 365 Launcher. Enabling this will assign the `HideApp` tag. Defaults to `false`.
        """
        if custom_single_sign_on is not None:
            pulumi.set(__self__, "custom_single_sign_on", custom_single_sign_on)
...
class SynchronizationJobProvisionOnDemandParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] rule_id: The identifier of the synchronization rule to be applied. This rule ID is defined in the schema for a given synchronization job or template.
...
class SynchronizationJobProvisionOnDemandParameterSubjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] object_type_name: The type of the object to which a synchronization job is to be applied. Can be one of the following: `user` for synchronizing between Active Directory and Azure AD, `User` for synchronizing a user between Azure AD and a third-party application, `Worker` for synchronization a user between Workday and either Active Directory or Azure AD, `Group` for synchronizing a group between Azure AD and a third-party application.
        """
        pulumi.set(__self__, "object_id", object_id)
...
class SynchronizationSecretCredentialArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: The key of the secret.
