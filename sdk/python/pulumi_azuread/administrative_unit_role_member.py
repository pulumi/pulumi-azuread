...
class AdministrativeUnitRoleMemberArgs:
    def __init__(__self__, *,
                 administrative_unit_object_id: pulumi.Input[builtins.str],
                 member_object_id: pulumi.Input[builtins.str],
                 role_object_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AdministrativeUnitRoleMember resource.
        :param pulumi.Input[builtins.str] administrative_unit_object_id: The object ID of the administrative unit you want to add the member to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] member_object_id: The object ID of the user, group or service principal you want to add as a member of the administrative unit. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] role_object_id: The object ID of the directory role you want to assign. Changing this forces a new resource to be created.
        """
    ...
    def administrative_unit_object_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def administrative_unit_object_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "administrative_unit_object_id", value)

    @property
    @pulumi.getter(name="memberObjectId")
    def member_object_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def member_object_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "member_object_id", value)

    @property
    @pulumi.getter(name="roleObjectId")
    def role_object_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def role_object_id(self, value: pulumi.Input[builtins.str]):
...
class _AdministrativeUnitRoleMemberState:
    def __init__(__self__, *,
                 administrative_unit_object_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="administrativeUnitObjectId")
    def administrative_unit_object_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The object ID of the administrative unit you want to add the member to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "administrative_unit_object_id")
    ...
    @administrative_unit_object_id.setter
    def administrative_unit_object_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "administrative_unit_object_id", value)
...
class AdministrativeUnitRoleMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            administrative_unit_object_id: Optional[pulumi.Input[builtins.str]] = None,
            member_object_id: Optional[pulumi.Input[builtins.str]] = None,
            role_object_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AdministrativeUnitRoleMember':
        """
    ...
    @property
    @pulumi.getter(name="administrativeUnitObjectId")
    def administrative_unit_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the administrative unit you want to add the member to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "administrative_unit_object_id")
    ...
    @property
    @pulumi.getter(name="memberObjectId")
    def member_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the user, group or service principal you want to add as a member of the administrative unit. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "member_object_id")
    ...
    @property
    @pulumi.getter(name="roleObjectId")
    def role_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the directory role you want to assign. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "role_object_id")
