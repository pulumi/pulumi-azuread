...
class SynchronizationJobProvisionOnDemandArgs:
    def __init__(__self__, *,
                 ...
                 synchronization_job_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The ID of the service principal for the synchronization job.
        :param pulumi.Input[builtins.str] synchronization_job_id: The ID of the synchronization job.
        """
    ...
    def synchronization_job_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def synchronization_job_id(self, value: pulumi.Input[builtins.str]):
...
class _SynchronizationJobProvisionOnDemandState:
    def __init__(__self__, *,
                 ...
                 synchronization_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="synchronizationJobId")
    def synchronization_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the synchronization job.
        """
        return pulumi.get(self, "synchronization_job_id")
    ...
    @synchronization_job_id.setter
    def synchronization_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "synchronization_job_id", value)
...
class SynchronizationJobProvisionOnDemand(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None,
            synchronization_job_id: Optional[pulumi.Input[builtins.str]] = None,
            triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'SynchronizationJobProvisionOnDemand':
        """
    ...
    @property
    @pulumi.getter(name="synchronizationJobId")
    def synchronization_job_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the synchronization job.
        """
        return pulumi.get(self, "synchronization_job_id")
