...
class ApplicationApiAccessArgs:
    def __init__(__self__, *,
                 api_client_id: pulumi.Input[builtins.str],
                 application_id: pulumi.Input[builtins.str],
                 role_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 scope_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ApplicationApiAccess resource.
        :param pulumi.Input[builtins.str] api_client_id: The client ID of the API to which access is being granted. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_ids: A set of role IDs to be granted to the application, as published by the API.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope_ids: A set of scope IDs to be granted to the application, as published by the API.
    ...
    def api_client_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def api_client_id(self, value: pulumi.Input[builtins.str]):
    ...
    def scope_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @scope_ids.setter
    def scope_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ApplicationApiAccessState:
    def __init__(__self__, *,
                 api_client_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="apiClientId")
    def api_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The client ID of the API to which access is being granted. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "api_client_id")
    ...
    @api_client_id.setter
    def api_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_client_id", value)
...
class ApplicationApiAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            application_id: Optional[pulumi.Input[builtins.str]] = None,
            role_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            scope_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApplicationApiAccess':
        """
    ...
    @property
    @pulumi.getter(name="apiClientId")
    def api_client_id(self) -> pulumi.Output[builtins.str]:
        """
        The client ID of the API to which access is being granted. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "api_client_id")
    ...
    @property
    @pulumi.getter(name="roleIds")
    def role_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A set of role IDs to be granted to the application, as published by the API.
        """
        return pulumi.get(self, "role_ids")
    ...
    @property
    @pulumi.getter(name="scopeIds")
    def scope_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A set of scope IDs to be granted to the application, as published by the API.
