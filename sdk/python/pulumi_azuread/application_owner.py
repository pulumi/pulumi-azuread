...
class ApplicationOwnerArgs:
    def __init__(__self__, *,
                 ...
                 owner_object_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] owner_object_id: The object ID of the owner to assign to the application, typically a user or service principal. Changing this forces a new resource to be created.
        """
    ...
    def owner_object_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def owner_object_id(self, value: pulumi.Input[builtins.str]):
...
class ApplicationOwner(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            application_id: Optional[pulumi.Input[builtins.str]] = None,
            owner_object_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationOwner':
        """
    ...
    @property
    @pulumi.getter(name="ownerObjectId")
    def owner_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the owner to assign to the application, typically a user or service principal. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "owner_object_id")
