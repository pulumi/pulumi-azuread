...
class _ApplicationFromTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The resource ID for the application.
        :param pulumi.Input[builtins.str] application_object_id: The object ID for the application.
        :param pulumi.Input[builtins.str] display_name: The display name for the application.
        :param pulumi.Input[builtins.str] service_principal_id: The resource ID for the service principal.
        :param pulumi.Input[builtins.str] service_principal_object_id: The object ID for the service principal.
        :param pulumi.Input[builtins.str] template_id: Unique ID for a templated application in the Azure AD App Gallery, from which to create the application. Changing this forces a new resource to be created.
        """
...
class ApplicationFromTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None,
            service_principal_object_id: Optional[pulumi.Input[builtins.str]] = None,
            template_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationFromTemplate':
        """
    ...
    @property
    @pulumi.getter(name="applicationObjectId")
    def application_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID for the application.
        """
        return pulumi.get(self, "application_object_id")
