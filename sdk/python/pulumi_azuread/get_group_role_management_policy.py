...
def get_group_role_management_policy(group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str group_id: The ID of the Azure AD group for which the policy applies.
    :param builtins.str role_id: The type of assignment this policy coveres. Can be either `member` or `owner`.
    """
    __args__ = dict()
...
def get_group_role_management_policy_output(group_id: Optional[pulumi.Input[builtins.str]] = None,
