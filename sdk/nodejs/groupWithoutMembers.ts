 ...
 * ```
 */
export class GroupWithoutMembers extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GroupWithoutMembersState, opts?: pulumi.CustomResourceOptions): GroupWithoutMembers {
        return new GroupWithoutMembers(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azuread:index/groupWithoutMembers:GroupWithoutMembers';

    /**
     * Returns true if the given object is an instance of GroupWithoutMembers.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GroupWithoutMembers {
     ...
     */
    declare public readonly dynamicMembership: pulumi.Output<outputs.GroupWithoutMembersDynamicMembership | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GroupWithoutMembersArgs | GroupWithoutMembersState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GroupWithoutMembersState | undefined;
            ...
            const args = argsOrState as GroupWithoutMembersArgs | undefined;
