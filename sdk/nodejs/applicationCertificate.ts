 ...
 *
 * const exampleApplication = new azuread.index/application.Application("example", {displayName: "example"});
 ...
 *     },
 * });
 * const exampleApplicationCertificate = new azuread.index/applicationCertificate.ApplicationCertificate("example", {
