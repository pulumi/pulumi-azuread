...
//
// This resource is analogous to the `requiredResourceAccess` block in the `Application` resource. When using these resources together, you should use the `ignoreChanges` lifecycle meta-argument (see example below).
//
// ## API Permissions
//
