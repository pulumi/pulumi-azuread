...
func NewServicePrincipalPassword(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azuread:index/servicePrincipalPassword:ServicePrincipalPassword", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetServicePrincipalPassword(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azuread:index/servicePrincipalPassword:ServicePrincipalPassword", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ServicePrincipalPassword{s: s}, nil
