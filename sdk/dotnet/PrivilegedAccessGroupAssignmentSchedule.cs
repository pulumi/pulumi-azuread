...
namespace Pulumi.AzureAD
{
    ...
    /// ```
    /// </summary>
    [AzureADResourceType("azuread:index/privilegedAccessGroupAssignmentSchedule:PrivilegedAccessGroupAssignmentSchedule")]
    public partial class PrivilegedAccessGroupAssignmentSchedule : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public PrivilegedAccessGroupAssignmentSchedule(string name, PrivilegedAccessGroupAssignmentScheduleArgs args, CustomResourceOptions? options = null)
            : base("azuread:index/privilegedAccessGroupAssignmentSchedule:PrivilegedAccessGroupAssignmentSchedule", name, args ?? new PrivilegedAccessGroupAssignmentScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivilegedAccessGroupAssignmentSchedule(string name, Input<string> id, PrivilegedAccessGroupAssignmentScheduleState? state = null, CustomResourceOptions? options = null)
            : base("azuread:index/privilegedAccessGroupAssignmentSchedule:PrivilegedAccessGroupAssignmentSchedule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PrivilegedAccessGroupAssignmentSchedule Get(string name, Input<string> id, PrivilegedAccessGroupAssignmentScheduleState? state = null, CustomResourceOptions? options = null)
        {
            return new PrivilegedAccessGroupAssignmentSchedule(name, id, state, options);
        }
    }

    public sealed class PrivilegedAccessGroupAssignmentScheduleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of assignment to the group. Can be either `member` or `owner`.
        /// </summary>
        ...
        public PrivilegedAccessGroupAssignmentScheduleArgs()
        {
        }
        public static new PrivilegedAccessGroupAssignmentScheduleArgs Empty => new PrivilegedAccessGroupAssignmentScheduleArgs();
    }

    public sealed class PrivilegedAccessGroupAssignmentScheduleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of assignment to the group. Can be either `member` or `owner`.
        /// </summary>
        ...
        public PrivilegedAccessGroupAssignmentScheduleState()
        {
        }
        public static new PrivilegedAccessGroupAssignmentScheduleState Empty => new PrivilegedAccessGroupAssignmentScheduleState();
    }
}
