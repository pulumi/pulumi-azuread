...
public class ServicePrincipalTokenSigningCertificate extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServicePrincipalTokenSigningCertificate(java.lang.String name) {
     ...
     */
    public ServicePrincipalTokenSigningCertificate(java.lang.String name, ServicePrincipalTokenSigningCertificateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServicePrincipalTokenSigningCertificate(java.lang.String name, ServicePrincipalTokenSigningCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/servicePrincipalTokenSigningCertificate:ServicePrincipalTokenSigningCertificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServicePrincipalTokenSigningCertificate(java.lang.String name, Output<java.lang.String> id, @Nullable ServicePrincipalTokenSigningCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/servicePrincipalTokenSigningCertificate:ServicePrincipalTokenSigningCertificate", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ServicePrincipalTokenSigningCertificate get(java.lang.String name, Output<java.lang.String> id, @Nullable ServicePrincipalTokenSigningCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
