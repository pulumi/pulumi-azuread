...
public class ApplicationKnownClients extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApplicationKnownClients(java.lang.String name) {
     ...
     */
    public ApplicationKnownClients(java.lang.String name, ApplicationKnownClientsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApplicationKnownClients(java.lang.String name, ApplicationKnownClientsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/applicationKnownClients:ApplicationKnownClients", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApplicationKnownClients(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationKnownClientsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/applicationKnownClients:ApplicationKnownClients", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ApplicationKnownClients get(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationKnownClientsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
