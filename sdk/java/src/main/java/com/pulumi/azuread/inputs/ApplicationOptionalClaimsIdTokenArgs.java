...
public final class ApplicationOptionalClaimsIdTokenArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationOptionalClaimsIdTokenArgs Empty = new ApplicationOptionalClaimsIdTokenArgs();
    ...
    private ApplicationOptionalClaimsIdTokenArgs() {}

    private ApplicationOptionalClaimsIdTokenArgs(ApplicationOptionalClaimsIdTokenArgs $) {
    ...
    public static Builder builder(ApplicationOptionalClaimsIdTokenArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApplicationOptionalClaimsIdTokenArgs defaults) {
            $ = new ApplicationOptionalClaimsIdTokenArgs(Objects.requireNonNull(defaults));
        }
