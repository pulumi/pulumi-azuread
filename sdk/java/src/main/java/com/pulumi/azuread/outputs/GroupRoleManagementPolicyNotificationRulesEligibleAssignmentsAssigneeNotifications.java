...
@CustomType
public final class GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications {
    /**
    ...
    private GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications() {}
    /**
     * @return The additional recipients to notify
     * 
     */
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications build() {
            final var _resultValue = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAssigneeNotifications();
