...
public final class GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs(GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
