...
public class AccessPackageAssignmentPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessPackageAssignmentPolicy(java.lang.String name) {
     ...
     */
    public AccessPackageAssignmentPolicy(java.lang.String name, AccessPackageAssignmentPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessPackageAssignmentPolicy(java.lang.String name, AccessPackageAssignmentPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/accessPackageAssignmentPolicy:AccessPackageAssignmentPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccessPackageAssignmentPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPackageAssignmentPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/accessPackageAssignmentPolicy:AccessPackageAssignmentPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AccessPackageAssignmentPolicyArgs makeArgs(AccessPackageAssignmentPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AccessPackageAssignmentPolicyArgs.Empty : args;
    }
     ...
     */
    public static AccessPackageAssignmentPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPackageAssignmentPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
