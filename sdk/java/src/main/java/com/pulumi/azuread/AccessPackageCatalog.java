...
public class AccessPackageCatalog extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessPackageCatalog(java.lang.String name) {
     ...
     */
    public AccessPackageCatalog(java.lang.String name, AccessPackageCatalogArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessPackageCatalog(java.lang.String name, AccessPackageCatalogArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/accessPackageCatalog:AccessPackageCatalog", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccessPackageCatalog(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPackageCatalogState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/accessPackageCatalog:AccessPackageCatalog", name, state, makeResourceOptions(options, id), false);
    }

    private static AccessPackageCatalogArgs makeArgs(AccessPackageCatalogArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AccessPackageCatalogArgs.Empty : args;
    }
     ...
     */
    public static AccessPackageCatalog get(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPackageCatalogState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
