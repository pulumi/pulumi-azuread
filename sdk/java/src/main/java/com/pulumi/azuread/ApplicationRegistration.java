...
public class ApplicationRegistration extends com.pulumi.resources.CustomResource {
     ...
     */
    public static ApplicationRegistration get(String name, Output<String> id, @Nullable ApplicationRegistrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
