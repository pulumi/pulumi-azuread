...
public class SynchronizationJob extends com.pulumi.resources.CustomResource {
    ...
    public SynchronizationJob(java.lang.String name, SynchronizationJobArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/synchronizationJob:SynchronizationJob", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SynchronizationJob(java.lang.String name, Output<java.lang.String> id, @Nullable SynchronizationJobState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azuread:index/synchronizationJob:SynchronizationJob", name, state, makeResourceOptions(options, id), false);
    }
