...
public final class ProviderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Disable the Terraform Partner ID, which is used if a custom `partnerId` isn&#39;t specified
     * 
     */
    ...
    /**
     * @return The cloud environment which should be used. Possible values are: `global` (also `public`), `usgovernmentl4` (also `usgovernment`), `usgovernmentl5` (also `dod`), and `china`. Defaults to `global`. Not used and should not be specified when `metadataHost` is specified.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param clientIdFilePath The path to a file containing the Client ID which should be used for service principal authentication
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param disableTerraformPartnerId Disable the Terraform Partner ID, which is used if a custom `partnerId` isn&#39;t specified
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param environment The cloud environment which should be used. Possible values are: `global` (also `public`), `usgovernmentl4` (also `usgovernment`), `usgovernmentl5` (also `dod`), and `china`. Defaults to `global`. Not used and should not be specified when `metadataHost` is specified.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param oidcTokenFilePath The path to a file containing an ID token for use when authenticating as a Service Principal using OpenID Connect.
         * 
         * @return builder
         * 
         */
