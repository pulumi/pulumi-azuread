...
public final class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
