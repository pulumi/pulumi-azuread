...
@CustomType
public final class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications {
    /**
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications build() {
            final var _resultValue = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotifications();
