...
@CustomType
public final class GroupRoleManagementPolicyEligibleAssignmentRules {
    /**
    ...
    public static Builder builder(GroupRoleManagementPolicyEligibleAssignmentRules defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String expireAfter;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyEligibleAssignmentRules defaults) {
        ...
        public GroupRoleManagementPolicyEligibleAssignmentRules build() {
            final var _resultValue = new GroupRoleManagementPolicyEligibleAssignmentRules();
