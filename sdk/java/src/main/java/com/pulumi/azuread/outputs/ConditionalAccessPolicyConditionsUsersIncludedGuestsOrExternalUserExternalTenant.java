...
public final class ConditionalAccessPolicyConditionsUsersIncludedGuestsOrExternalUserExternalTenant {
    ...
    public static Builder builder(ConditionalAccessPolicyConditionsUsersIncludedGuestsOrExternalUserExternalTenant defaults) {
    ...
    public static final class Builder {
        ...
        private String membershipKind;
        public Builder() {}
        public Builder(ConditionalAccessPolicyConditionsUsersIncludedGuestsOrExternalUserExternalTenant defaults) {
        ...
        public Builder membershipKind(String membershipKind) {
            if (membershipKind == null) {
              throw new MissingRequiredPropertyException("ConditionalAccessPolicyConditionsUsersIncludedGuestsOrExternalUserExternalTenant", "membershipKind");
            }
