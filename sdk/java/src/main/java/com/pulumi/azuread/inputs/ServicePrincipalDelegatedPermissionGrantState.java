...
public final class ServicePrincipalDelegatedPermissionGrantState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<String>>> claimValues() {
        return Optional.ofNullable(this.claimValues);
    }
     ...
     * 
     */
    public Optional<Output<String>> resourceServicePrincipalObjectId() {
        return Optional.ofNullable(this.resourceServicePrincipalObjectId);
    }
    ...
    private ServicePrincipalDelegatedPermissionGrantState(ServicePrincipalDelegatedPermissionGrantState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePrincipalDelegatedPermissionGrantState();
        }

        public Builder(ServicePrincipalDelegatedPermissionGrantState defaults) {
            $ = new ServicePrincipalDelegatedPermissionGrantState(Objects.requireNonNull(defaults));
        }
