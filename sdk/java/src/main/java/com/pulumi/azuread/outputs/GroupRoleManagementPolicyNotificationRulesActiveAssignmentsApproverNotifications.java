...
@CustomType
public final class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications {
    /**
    ...
    private GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications() {}
    /**
     * @return The additional recipients to notify
     * 
     */
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications build() {
            final var _resultValue = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications();
