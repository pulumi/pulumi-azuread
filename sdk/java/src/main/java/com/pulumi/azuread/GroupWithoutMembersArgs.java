...
public final class GroupWithoutMembersArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupWithoutMembersArgs Empty = new GroupWithoutMembersArgs();
    ...
    private @Nullable Output<GroupWithoutMembersDynamicMembershipArgs> dynamicMembership;
     ...
     * 
     */
    public Optional<Output<GroupWithoutMembersDynamicMembershipArgs>> dynamicMembership() {
    ...
    private GroupWithoutMembersArgs() {}

    private GroupWithoutMembersArgs(GroupWithoutMembersArgs $) {
    ...
    public static Builder builder(GroupWithoutMembersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupWithoutMembersArgs();
        }

        public Builder(GroupWithoutMembersArgs defaults) {
            $ = new GroupWithoutMembersArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param assignableToRole Indicates whether this group can be assigned to an Azure Active Directory role. Defaults to `false`. Can only be set to `true` for security-enabled groups. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dynamicMembership A `dynamicMembership` block as documented below. Required when `types` contains `DynamicMembership`. Cannot be used with the `members` property.
         * 
         * @return builder
         * 
         */
        public Builder dynamicMembership(@Nullable Output<GroupWithoutMembersDynamicMembershipArgs> dynamicMembership) {
         ...
         * 
         */
        public Builder dynamicMembership(GroupWithoutMembersDynamicMembershipArgs dynamicMembership) {
        ...
        /**
         * @param mailEnabled Whether the group is a mail enabled, with a shared group mailbox. At least one of `mailEnabled` or `securityEnabled` must be specified. Only Microsoft 365 groups can be mail enabled (see the `types` property).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param securityEnabled Whether the group is a security group for controlling access to in-app resources. At least one of `securityEnabled` or `mailEnabled` must be specified. A Microsoft 365 group can be security enabled _and_ mail enabled (see the `types` property).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param types A set of group types to configure for the group. Supported values are `DynamicMembership`, which denotes a group with dynamic membership, and `Unified`, which specifies a Microsoft 365 group. Required when `mailEnabled` is true. Changing this forces a new resource to be created.
         * 
         * &gt; **Supported Group Types** At present, only security groups and Microsoft 365 groups can be created or managed with this resource. Distribution groups and mail-enabled security groups are not supported. Microsoft 365 groups can be security-enabled.
         * 
         * @return builder
        ...
        public GroupWithoutMembersArgs build() {
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("GroupWithoutMembersArgs", "displayName");
            }
            return $;
        }
    }
