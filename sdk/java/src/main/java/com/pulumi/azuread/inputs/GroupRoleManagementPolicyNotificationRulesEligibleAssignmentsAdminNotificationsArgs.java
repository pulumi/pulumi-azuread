...
public final class GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
