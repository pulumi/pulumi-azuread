...
@CustomType
public final class GroupRoleManagementPolicyActiveAssignmentRules {
    /**
    ...
    public static Builder builder(GroupRoleManagementPolicyActiveAssignmentRules defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean requireTicketInfo;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyActiveAssignmentRules defaults) {
        ...
        public GroupRoleManagementPolicyActiveAssignmentRules build() {
            final var _resultValue = new GroupRoleManagementPolicyActiveAssignmentRules();
