...
public final class GetApplicationOptionalClaimAccessToken {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetApplicationOptionalClaimAccessToken", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public GetApplicationOptionalClaimAccessToken build() {
            final var _resultValue = new GetApplicationOptionalClaimAccessToken();
