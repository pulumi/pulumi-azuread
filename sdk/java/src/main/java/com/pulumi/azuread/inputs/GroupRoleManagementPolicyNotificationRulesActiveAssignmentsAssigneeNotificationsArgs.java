...
public final class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs() {}

    private GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
