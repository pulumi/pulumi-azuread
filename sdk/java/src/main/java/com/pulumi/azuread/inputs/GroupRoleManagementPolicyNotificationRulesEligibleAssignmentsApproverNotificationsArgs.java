...
public final class GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
