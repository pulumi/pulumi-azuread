...
@CustomType
public final class GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications {
    /**
    ...
    private GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications() {}
    /**
     * @return The additional recipients to notify
     * 
     */
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications build() {
            final var _resultValue = new GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications();
