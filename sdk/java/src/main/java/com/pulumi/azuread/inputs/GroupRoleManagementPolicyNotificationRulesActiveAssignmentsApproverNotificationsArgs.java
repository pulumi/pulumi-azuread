...
public final class GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs Empty = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs();
    ...
    private GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs $) {
    ...
    public static Builder builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs();
        }

        public Builder(GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs defaults) {
            $ = new GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("GroupRoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
